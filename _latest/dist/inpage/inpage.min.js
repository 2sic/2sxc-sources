...
var TranslatorGlobal = /** @class */ (function (_super) {
    ...
    TranslatorGlobal.prototype.initManager = function (manage) {
        ...
        this.i18n
            ...
            backend: {
                loadPath: Object(_logging__WEBPACK_IMPORTED_MODULE_6__["urlClean"])(realRootPath + ___WEBPACK_IMPORTED_MODULE_2__["translationsPath"]),
            },
...
var Manage = /** @class */ (function () {
    ...
    Manage.prototype.initInstance = function (sxc) {
        try {
            ...
            var userInfo = _context__WEBPACK_IMPORTED_MODULE_1__["ContextOfUser"].fromContext(myContext);
...
/* harmony import */ var _logging__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../logging */ "./src/logging/index.ts");
/* harmony import */ var _quick_dialog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./quick-dialog */ "./src/quick-dialog/quick-dialog.ts");
/* harmony import */ var _quick_dialog_config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./quick-dialog-config */ "./src/quick-dialog/quick-dialog-config.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var IFrameBridge = /** @class */ (function (_super) {
    ...
    IFrameBridge.prototype.getAdditionalDashboardConfig = function () {
        ...
        return cl.return(_quick_dialog_config__WEBPACK_IMPORTED_MODULE_7__["QuickDialogConfig"].fromContext(this.getContext()));
    };
    IFrameBridge.prototype.hide = function () {
        _quick_dialog__WEBPACK_IMPORTED_MODULE_6__["QuickDialog"].setVisible(false);
    };
    IFrameBridge.prototype.run = function (verb) {
        this.uncachedSxc().manage.run(verb);
    };
    IFrameBridge.prototype.cancel = function () { _quick_dialog__WEBPACK_IMPORTED_MODULE_6__["QuickDialog"].cancel(this); };
    ...
    IFrameBridge.prototype.setTemplate = function (templateId, templateName, final) {
        ...
        if (final)
            promise = promise.then(function () { return _quick_dialog__WEBPACK_IMPORTED_MODULE_6__["QuickDialog"].setVisible(false); });
        promise = ajax
    ...
    IFrameBridge.prototype.setup = function (sxc, dialogName) {
        ...
        this.tagModule = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_3__["$jq"])(Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_3__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_4__["SxcEdit"].getTag(sxc)).parent().eq(0));
    ...
    IFrameBridge.prototype.scrollToTarget = function (target) {
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_3__["$jq"])('body').animate(specs, animationTime);
        cl.done();
    };
    return IFrameBridge;
}(_logging__WEBPACK_IMPORTED_MODULE_5__["HasLog"]));
...
/* harmony import */ var _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../interfaces/sxc-controller-in-page */ "./src/interfaces/sxc-controller-in-page.ts");
/* harmony import */ var _logging___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../logging/ */ "./src/logging/index.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var QuickDialogContainer = /** @class */ (function (_super) {
    ...
    QuickDialogContainer.prototype.getOrCreate = function () {
        var container = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])("." + containerClass);
    ...
    QuickDialogContainer.prototype.buildContainerAndIFrame = function () {
        ...
        var container = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(containerTemplate);
        if (Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('#personaBar-iframe').length > 0)
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('body').append(container);
...
}(_logging___WEBPACK_IMPORTED_MODULE_2__["HasLog"]));
...
var ModifierContentBlock = /** @class */ (function (_super) {
    ...
    ModifierContentBlock.prototype.findListIndex = function (tag, fallback) {
        var _a, _b;
        var editContext = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_2__["SxcEdit"].getEditContextOfTag(tag);
    ...
    ModifierContentBlock.onCbButtonClick = function () {
        var target = ___WEBPACK_IMPORTED_MODULE_0__["QuickE"].main.activeContentBlock;
        var blockTag = target[0];
        var button = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this);
        var list = target.closest(___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].blocks.cb.listSelector);
        ...
        var domIndex = target.hasClass(___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].blocks.cb.class)
            ? listItems.index(blockTag) + 1
            : 0;
        // Check if it's a cut/paste action
        var cbAction = button.data('action');
        if (cbAction)
            return ___WEBPACK_IMPORTED_MODULE_0__["QuickEClipboard"].do(cbAction, list, domIndex, ___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].blocks.cb.id);
        ...
        var listIndex = ___WEBPACK_IMPORTED_MODULE_0__["QuickEClipboard"].modCb.findListIndex(blockTag, domIndex - 1) + 1;
        var appOrContent = button.data('type');
        return ___WEBPACK_IMPORTED_MODULE_0__["QuickEClipboard"].modCb.create(actionConfig.parent, actionConfig.field, listIndex, appOrContent, list, newGuid);
    };
...
var QuickEClipboardSingleton = /** @class */ (function (_super) {
     ...
     * @param type
     */
    QuickEClipboardSingleton.prototype.do = function (cbAction, list, domIndex, type) {
    ...
    QuickEClipboardSingleton.prototype.createSpecs = function (type, list, domIndex) {
