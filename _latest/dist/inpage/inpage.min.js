...
/*!***************************************!*\
  !*** ../$2sxc/src/constants/index.ts ***!
  \***************************************/
/*! exports provided: ApiExtensionPlaceholder, MetaHeaderJsApi, DnnUiRoot */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var EnvironmentMetaLoader = /** @class */ (function (_super) {
    ...
    EnvironmentMetaLoader.prototype.loadMetaFromHeader = function (forceFallback) {
        ...
        // Load the settings
        this.env.load(JSON.parse(meta), MetaSourceId);
     ...
     */
    EnvironmentMetaLoader.prototype.startObserver = function () {
        var _this = this;
        if (!!this.observer)
            return;
        this.observer = new MutationObserver(function (mutationsList) {
            for (var _i = 0, mutationsList_1 = mutationsList; _i < mutationsList_1.length; _i++) {
                ...
                if (mutation.type === 'attributes' && mutation.attributeName === MetaProperty) {
                    _this.log.add('meta env info updated');
                    _this.env.load(JSON.parse(_this.getMetaContent()), MetaSourceId);
                }
            }
        });
...
/*!*****************************!*\
  !*** ../$2sxc/src/index.ts ***!
  \*****************************/
/*! exports provided: ToSxcName, SxcVersion, SxcApiUrlRoot, HeaderNames, NumberNotDefinedHuge, LogEntryOptions, HasLog, Log, LogCall, Entry, Insights, Obj, urlClean, TotalPopup, UrlParamManager, Environment, SxcHttp, SxcInstance, SxcInstanceWithInternals, SxcWebApi, AjaxPromise, SxcInstanceDataDeprecated, Debug, ContextIdentifier, isContextIdentifier, throwIfIncomplete, getRootPartsV2, buildSxcRoot */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "throwIfIncomplete", function() { return _sxc_root_context_identifier__WEBPACK_IMPORTED_MODULE_7__["throwIfIncomplete"]; });
...
var SxcInstanceDataDeprecated = /** @class */ (function () {
    ...
    SxcInstanceDataDeprecated.prototype.sourceUrl = function (params) {
        var url = this.controller.root.http.apiUrl('app/auto/InstanceData');
...
/*!***************************************************!*\
  !*** ../$2sxc/src/sxc-root/context-identifier.ts ***!
  \***************************************************/
/*! exports provided: ContextIdentifier, isContextIdentifier, throwIfIncomplete */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "throwIfIncomplete", function() { return throwIfIncomplete; });
...
function throwIfIncomplete(ctx) {
...
function FindSxcInstance(id, cbid) {
    ...
    if (Object(_context_identifier__WEBPACK_IMPORTED_MODULE_6__["isContextIdentifier"])(id)) {
        Object(_context_identifier__WEBPACK_IMPORTED_MODULE_6__["throwIfIncomplete"])(id);
        ctxId = id;
...
/*!************************!*\
  !*** ../core/index.ts ***!
  \************************/
/*! exports provided: ToSxcName, SxcVersion, SxcApiUrlRoot, HeaderNames, NumberNotDefinedHuge, LogEntryOptions, HasLog, Log, LogCall, Entry, Insights, Obj, urlClean */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var BootstrapInPage = /** @class */ (function (_super) {
    ...
    function BootstrapInPage() {
        ...
        _logging__WEBPACK_IMPORTED_MODULE_5__["Insights"].add('system', 'bootstrap', _this.log);
        return _this;
    }
    ...
    BootstrapInPage.prototype.initAllInstances = function (isFirstRun) {
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])('div[data-edit-context]').each(function (i, e) {
            _this.initInstance(Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(e), isFirstRun);
        });
        if (isFirstRun)
    ...
    BootstrapInPage.prototype.watchDomChanges = function () {
        ...
        var observer = new MutationObserver(function (m) {
            ...
            _interfaces_window_in_page__WEBPACK_IMPORTED_MODULE_4__["windowInPage"].$2sxc.stats.watchDomChanges++;
            var processed = 0;
            ...
            m.forEach(function (v) {
                Array.prototype.forEach.call(v.addedNodes, function (n) {
                    var node = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(n);
                    ...
                    if (node.is('div[data-edit-context]')) {
                        ...
                        if (!_quick_dialog__WEBPACK_IMPORTED_MODULE_6__["QuickDialog"].isVisible())
                    ...
                    // .active-module class which seems to be applied while dragging the module.
                        ...
                        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])('div[data-edit-context]', node).each(function (i, e) {
                            _this.initInstance(Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(e), false);
                        });
                    }
                    else
                        _toolbar_toolbar_manager__WEBPACK_IMPORTED_MODULE_9__["ToolbarManager"].build(node);
                });
            });
    ...
    BootstrapInPage.prototype.tryShowTemplatePicker = function () {
        ...
        if (openDialogId) {
            ...
            var found = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])("[data-cb-id=\"" + openDialogId + "\"]");
            if (found.length) {
                ...
                if (openDialogId < 0) {
                    ...
                    sxc = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].get(instanceId, openDialogId);
                }
                else
                    sxc = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].get(openDialogId);
            }
        }
        if (!sxc) {
            var uninitializedModules = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])('.sc-uninitialized');
            ...
            sxc = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].get(module_1);
        }
        if (sxc) {
    ...
    BootstrapInPage.prototype.initInstance = function (module, isFirstRun) {
        ...
        var sxc = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].get(module);
        ...
        if (isFirstRun || !wasEmpty) {
            ...
            var log = new _logging__WEBPACK_IMPORTED_MODULE_5__["Log"]('Bts.Module');
            _toolbar_toolbar_manager__WEBPACK_IMPORTED_MODULE_9__["ToolbarManager"].buildModule(module);
        }
        cl.done();
    };
    BootstrapInPage.prototype.showGlassesButtonIfUninitialized = function (sxci) {
        ...
        var tag = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].getTag(sxci));
        if (tag.find('.sc-uninitialized').length !== 0)
            return callLog.return(false, 'already has button');
        // note: title is added on mouseover, as the translation isn't ready at page-load
        var btn = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])('<div class="sc-uninitialized" onmouseover="this.title = $2sxc.translate(this.title)" title="InPage.NewElement">' +
...
var CommandLinkGenerator = /** @class */ (function (_super) {
    ...
    CommandLinkGenerator.prototype.getDialogUrl = function (dialogName) {
        ...
        //     ? C.DialogPaths.ng8
        //     : C.DialogPaths.ng1;
        return Object(_plumbing__WEBPACK_IMPORTED_MODULE_5__["urlClean"])("" + context.instance.sxcRootUrl + _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$2sxcInPage"].env.uiRoot() + _constants__WEBPACK_IMPORTED_MODULE_0__["C"].DialogPaths.ng8) + ("?sxcver=" + context.instance.sxcVersion);
    };
...
var webApiItemPublish = 'cms/item/publish';
...
/* harmony import */ var _quick_edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../quick-edit */ "./src/quick-edit/index.ts");
/* harmony import */ var _quick_edit_context_for_lists__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../quick-edit/context-for-lists */ "./src/quick-edit/context-for-lists.ts");
/* harmony import */ var _commands__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../commands */ "./src/commands/commands.ts");
 ...
 * import this module to commands.ts
 */
_commands__WEBPACK_IMPORTED_MODULE_5__["Commands"].add(CmdLayout, 'ChangeLayout', 'glasses', true, true, {
    inlineWindow: function (_) { return true; },
    code: function (context, event) {
        // console.log('layout');
        // Try to find the closest tag based on the click
        // if this fails, try to find it based on the sxc-instance
        var attrSel = '[' + _quick_edit__WEBPACK_IMPORTED_MODULE_3__["QeSelectors"].blocks.cb.context + ']';
        // note: sometimes when the page loads, this can be auto-triggered and not have an event
        var listSpecs = event && Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(event.target).closest(attrSel);
        if (!Array.isArray(listSpecs) || listSpecs.length === 0)
            listSpecs = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_2__["SxcEdit"].getTag(context.sxc)).closest(attrSel);
        // Now check if we have apps-parameters to pass on
        if (listSpecs.length > 0) {
            var specs = _quick_edit_context_for_lists__WEBPACK_IMPORTED_MODULE_4__["ContextForLists"].getFromDom(listSpecs);
...
var RendererGlobal = /** @class */ (function (_super) {
    ...
    RendererGlobal.prototype.showMessage = function (context, newContent) {
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].getTag(context.sxc)).html(newContent);
    };
    /**
    ...
    RendererGlobal.prototype.ajaxLoad = function (context, alternateTemplateId, justPreview) {
        ...
        return _content_block_editor__WEBPACK_IMPORTED_MODULE_7__["ContentBlockEditor"].getPreviewWithTemplate(context, alternateTemplateId)
            .then(function (result) {
            ...
            _quick_edit_quick_e__WEBPACK_IMPORTED_MODULE_6__["QuickE"].reset(); // reset quick-edit, because the config could have changed
            cl.done();
        });
    };
    /**
    ...
    RendererGlobal.prototype.replaceContentBlock = function (context, newContent, justPreview) {
        ...
        try {
            var newDom = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(newContent);
            // Must disable toolbar before we attach to DOM
            if (justPreview)
                _html_dom_tools__WEBPACK_IMPORTED_MODULE_1__["HtmlTools"].disable(newDom);
            Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].getTag(context.sxc)).replaceWith(newDom);
...
var ContextOfApp = /** @class */ (function () {
    function ContextOfApp(editCtx, sxc) {
        ...
        if (editCtx.ContentGroup) {
            ...
            this.isContent = (_a = editCtx.ContentGroup.IsContent) !== null && _a !== void 0 ? _a : true;
            this.resourcesId = (_b = editCtx.ContentGroup.AppResourcesId) !== null && _b !== void 0 ? _b : null;
            this.settingsId = (_c = editCtx.ContentGroup.AppSettingsId) !== null && _c !== void 0 ? _c : null;
            ...
            this.supportsAjax = (_d = editCtx.ContentGroup.SupportsAjax) !== null && _d !== void 0 ? _d : false;
...
var ContextOfContentBlock = /** @class */ (function () {
    function ContextOfContentBlock(editCtx) {
        // ContentBlock
        this.id = _core__WEBPACK_IMPORTED_MODULE_0__["NumberNotDefinedHuge"]; // the CB ID
...
var ContextOfInstance = /** @class */ (function () {
    function ContextOfInstance(editCtx, sxc) {
        ...
        if (!this.id && ((_d = sxc === null || sxc === void 0 ? void 0 : sxc.ctx) === null || _d === void 0 ? void 0 : _d.moduleId))
            this.id = sxc.ctx.moduleId;
        if (editCtx.ContentBlock)
            this.allowPublish = editCtx.ContentBlock.VersioningRequirements === _constants__WEBPACK_IMPORTED_MODULE_1__["C"].IDs.publishAllowed;
    }
...
var ContextOfPage = /** @class */ (function () {
    ...
    function ContextOfPage(editCtx, sxc) {
        ...
        this.id = (_c = (_a = this.id) !== null && _a !== void 0 ? _a : (_b = sxc === null || sxc === void 0 ? void 0 : sxc.ctx) === null || _b === void 0 ? void 0 : _b.pageId) !== null && _c !== void 0 ? _c : _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$2sxcInPage"].env.page();
    }
...
var HtmlTools = /** @class */ (function () {
    ...
    HtmlTools.disable = function (tag) {
        var jtag = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(tag);
        jtag.attr(_constants__WEBPACK_IMPORTED_MODULE_0__["C"].Toolbar.attr.disable, 'true');
    };
    HtmlTools.isDisabled = function (sxc) {
        var tag = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_2__["SxcEdit"].getTag(sxc));
...
/* harmony import */ var _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../interfaces/sxc-instance-editable */ "./src/interfaces/sxc-instance-editable.ts");
/* harmony import */ var _logging__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../logging */ "./src/logging/index.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var TranslatorGlobal = /** @class */ (function (_super) {
    ...
    function TranslatorGlobal() {
        ...
        _logging__WEBPACK_IMPORTED_MODULE_6__["Insights"].add('system', 'translator', _this.log);
    ...
    TranslatorGlobal.prototype.initManager = function (manage) {
        ...
        var realRootPath = _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$2sxcInPage"].env.uiRoot();
        this.i18n
            ...
            backend: {
                loadPath: Object(_logging__WEBPACK_IMPORTED_MODULE_6__["urlClean"])(context.instance.sxcRootUrl + realRootPath + ___WEBPACK_IMPORTED_MODULE_2__["translationsPath"]),
            },
    ...
    TranslatorGlobal.prototype.tryToFindAContext = function () {
        ...
        var htmlElementOrId = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$jq"])('div[data-cb-id]')[0];
        this.initialized = true; // the next SxcEdit.get will call _translate so we must set true to prevent loops
        var sxc = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_5__["SxcEdit"].get(htmlElementOrId);
        this.initialized = false; // for real, it is not initialized...
        var editContext = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_5__["SxcEdit"].getEditContext(sxc);
        var context = new _context_bundles__WEBPACK_IMPORTED_MODULE_3__["ContextComplete"](editContext, sxc);
        context.sxc = sxc;
    ...
    TranslatorGlobal.prototype.initjQuery = function () {
        ...
        jqueryI18next.init(i18next__WEBPACK_IMPORTED_MODULE_0__["default"], _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$jq"]);
    ...
    TranslatorGlobal.prototype.autoTranslateMenus = function () {
        ...
        var menus = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$jq"])('ul.sc-menu');
        menus.localize(); // inline toolbars
        var quickEButtons = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$jq"])('.sc-i18n');
...
}(_logging__WEBPACK_IMPORTED_MODULE_6__["HasLog"]));
...
Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_5__["$jq"])(document).ready(loadInpage);
// #dropJquery
...
/*!**************************************************!*\
  !*** ./src/interfaces/sxc-controller-in-page.ts ***!
  \**************************************************/
/*! exports provided: $2sxcInPage, $jq, $original */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "$2sxcInPage", function() { return $2sxcInPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "$jq", function() { return $jq; });
...
var $jq = $; // window.$2sxc.jq(); // as JQueryStatic;
var $original = $;
...
/* harmony import */ var _sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sxc-controller-in-page */ "./src/interfaces/sxc-controller-in-page.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var SxcEdit = /** @class */ (function (_super) {
    ...
    SxcEdit.getContainerTag = function (htmlTag) {
        return Object(_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(htmlTag).closest('div[data-edit-context]')[0];
    };
    /**
    ...
    SxcEdit.getTag = function (sxci) {
        return Object(_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])("div[data-cb-id='" + sxci.cbid + "']")[0];
    };
    return SxcEdit;
...
function getEditContextOfTag(htmlTag) {
    var attr = htmlTag === null || htmlTag === void 0 ? void 0 : htmlTag.getAttribute('data-edit-context');
...
var EditManager = /** @class */ (function () {
    ...
    EditManager.prototype.getButton = function (actDef, groupIndex) {
        this.context.button = _toolbar__WEBPACK_IMPORTED_MODULE_2__["ToolbarManager"].getLoader('getButton')
    ...
    EditManager.prototype.getToolbar = function (tbConfig, moreSettings) {
        ...
        var toolbarConfig = _toolbar__WEBPACK_IMPORTED_MODULE_2__["ToolbarManager"].loadConfig(this.context, tbConfig);
...
var NgUrlValuesWithoutParams = /** @class */ (function () {
    function NgUrlValuesWithoutParams(context, partOfPage) {
        ...
        // New in 11.05.01
        this.api = _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$2sxcInPage"].env.api();
        this.uiRoot = _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$2sxcInPage"].env.uiRoot();
...
/*!*******************************!*\
  !*** ./src/plumbing/index.ts ***!
  \*******************************/
/*! exports provided: isNothing, ToSxcName, SxcVersion, SxcApiUrlRoot, HeaderNames, NumberNotDefinedHuge, LogEntryOptions, HasLog, Log, LogCall, Entry, Insights, Obj, urlClean */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../interfaces/sxc-controller-in-page */ "./src/interfaces/sxc-controller-in-page.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var IFrameBridge = /** @class */ (function (_super) {
    ...
    IFrameBridge.prototype.setup = function (sxc, dialogName) {
        ...
        this.tagModule = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_7__["$jq"])(Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_7__["$jq"])(_interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_3__["SxcEdit"].getTag(sxc)).parent().eq(0));
    ...
    IFrameBridge.prototype.scrollToTarget = function (target) {
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_7__["$jq"])('body').animate(specs, animationTime);
        cl.done();
    };
    return IFrameBridge;
}(_logging__WEBPACK_IMPORTED_MODULE_4__["HasLog"]));
...
/* harmony import */ var _iDialogFrameElement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./iDialogFrameElement */ "./src/quick-dialog/iDialogFrameElement.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var IDialogFrameElement = _iDialogFrameElement__WEBPACK_IMPORTED_MODULE_2__["IDialogFrameElement"];
/**
...
var QuickDialogContainer = /** @class */ (function (_super) {
    ...
    QuickDialogContainer.prototype.getOrCreate = function () {
        var container = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])("." + containerClass);
    ...
    QuickDialogContainer.prototype.buildContainerAndIFrame = function () {
        ...
        var container = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])(containerTemplate);
        if (Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])('#personaBar-iframe').length > 0)
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])('body').append(container);
...
var QuickDialogManagerSingleton = /** @class */ (function (_super) {
    ...
    function QuickDialogManagerSingleton() {
        ...
        _logging__WEBPACK_IMPORTED_MODULE_3__["Insights"].add('quick-dialog', 'manager', _this.log);
        _this.container = new _quick_dialog_container__WEBPACK_IMPORTED_MODULE_4__["QuickDialogContainer"](_this);
        return _this;
    }
    /**
    ...
    QuickDialogManagerSingleton.prototype.cancel = function (bridge) {
        ...
        _state__WEBPACK_IMPORTED_MODULE_5__["cancelled"].set('true');
    ...
    QuickDialogManagerSingleton.prototype.rememberDialogState = function (iframe, state) {
        ...
        if (state) {
            ...
            return callLog.return(_state__WEBPACK_IMPORTED_MODULE_5__["cbId"].set(cbId));
        }
        return callLog.return(_state__WEBPACK_IMPORTED_MODULE_5__["cbId"].remove(), 'remove');
    };
    ...
    QuickDialogManagerSingleton.prototype.changePathToLocalhostForDev = function (url) {
        ...
        try {
            ...
            if (devMode && !!devMode)
                return url.replace(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_2__["$2sxcInPage"].env.uiRoot() + 'dist/ng/ui.html', 'http://localhost:4200');
        }
        catch (e) {
            // ignore
        }
...
var ContextForLists = /** @class */ (function () {
    ...
    ContextForLists.getFromDom = function (tag) {
        var result = JSON.parse(Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(tag).attr(___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].blocks.cb.context) || null) || {};
...
var ModifierContentBlockInstance = /** @class */ (function (_super) {
    ...
    ModifierContentBlockInstance.prototype.create = function (parentId, fieldName, index, appName, container, newGuid) {
        ...
        var jqPromise = this.sxcInstance.webApi
            ...
            .then(function (result) {
            var newTag = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$jq"])(result); // prepare tag for inserting
            // should I add it to a specific position...
            if (cblockList.length > 0 && index > 0)
                Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_4__["$jq"])(cblockList[cblockList.length > index - 1 ? index - 1 : cblockList.length - 1])
                    .after(newTag);
...
/* harmony import */ var _modifier_content_block_internal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modifier-content-block-internal */ "./src/quick-edit/modifier-content-block-internal.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ModifierContentBlock = /** @class */ (function (_super) {
    ...
    ModifierContentBlock.prototype.getInstanceModifier = function (tag) {
        var sxc = _interfaces_sxc_instance_editable__WEBPACK_IMPORTED_MODULE_2__["SxcEdit"].get(tag);
        return new _modifier_content_block_internal__WEBPACK_IMPORTED_MODULE_4__["ModifierContentBlockInstance"](this, sxc);
    };
    ...
    ModifierContentBlock.onCbButtonClick = function () {
        ...
        var actionConfig = _context_for_lists__WEBPACK_IMPORTED_MODULE_3__["ContextForLists"].getFromDom(list);
        var index = 0;
        ...
        var cbAction = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this).data('action');
        if (cbAction)
        ...
        var appOrContent = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this).data('type');
...
var ModifierDnnModuleInternal = /** @class */ (function (_super) {
    ...
    ModifierDnnModuleInternal.prototype.move = function (modId, pane, order) {
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(window).resize();
    };
    ModifierDnnModuleInternal.prototype.getPaneName = function (pane) {
        return Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(pane).attr('id').replace('dnn_', '');
    };
    /**
    ...
    ModifierDnnModuleInternal.prototype.getMoveButtons = function (current) {
        ...
        var targets = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('<div>');
        ...
        targets.find('a').on('click', function () {
            var link = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this);
...
var ModifierDnnModule = /** @class */ (function (_super) {
    ...
    ModifierDnnModule.onModuleButtonClick = function () {
        var type = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this).data('type');
...
var QuickEClipboardSingleton = /** @class */ (function (_super) {
    ...
    function QuickEClipboardSingleton() {
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(function () { return _this.initializeSecondaryButtons(); });
        return _this;
    }
    /**
    ...
    QuickEClipboardSingleton.prototype.initializeSecondaryButtons = function () {
        ...
        var qem = this;
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('a', ___WEBPACK_IMPORTED_MODULE_0__["QuickE"].selected).on('click', function () {
            var action = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this).data('action');
            switch (action) {
    ...
    QuickEClipboardSingleton.prototype.mark = function (newData) {
        ...
        if (!this.clipboard.item)
            return cl.done();
        var cb = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(this.clipboard.item);
    ...
    QuickEClipboardSingleton.prototype.removeSelectionMarker = function () {
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])("." + ___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].selected).removeClass(___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].selected);
    };
    QuickEClipboardSingleton.prototype.setSecondaryActionsState = function (state) {
        var cl = this.log.call('setSecondaryActionsState');
        var btns = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('a.sc-content-block-menu-btn');
    ...
    QuickEClipboardSingleton.prototype.createSpecs = function (type, list, index) {
        ...
        var currentItem = (index >= listItems.length)
            ...
            : listItems[index];
        var editContext = _context_for_lists__WEBPACK_IMPORTED_MODULE_3__["ContextForLists"].getFromDom(list) || {
            parent: 'dnn',
            field: list.id,
            parentGuid: null,
        };
...
var selectedOverlay = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])("<div class='sc-content-block-menu sc-content-block-selected-menu sc-i18n'></div>")
...
var QuickESingleton = /** @class */ (function (_super) {
    ...
    function QuickESingleton() {
        ...
        _this.body = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$original"])('body');
        _this.win = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$original"])(window);
        _this.main = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$original"])("<div class='sc-content-block-menu sc-content-block-quick-insert sc-i18n'></div>");
        ...
        _this.cbActions = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$original"])(_this.template);
        _this.modActions = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$original"])(_this.template.replace(/QuickInsertMenu.AddBlock/g, 'QuickInsertMenu.AddModule'))
            .attr('data-context', 'module')
            .addClass('sc-content-block-menu-module');
        //
        _this.config = getNewDefaultConfig();
        _logging__WEBPACK_IMPORTED_MODULE_2__["Insights"].add('Q-E', 'manager', _this.log);
        _this.modActions.on('click', ___WEBPACK_IMPORTED_MODULE_0__["ModifierDnnModule"].onModuleButtonClick);
        _this.cbActions.on('click', ___WEBPACK_IMPORTED_MODULE_0__["ModifierContentBlock"].onCbButtonClick);
        return _this;
    }
    ...
    QuickESingleton.prototype.loadPageConfig = function () {
        ...
        this.logConfig();
        var configs = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])("[" + configAttr + "]");
        var confJ;
        if (configs.length > 0) {
    ...
    QuickESingleton.prototype.detectWhichMenusToActivate = function () {
        ...
        var innerCBs = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].blocks.cb.listSelector);
    ...
    QuickESingleton.prototype.initPanes = function () {
        ...
        this.cachedPanes = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(___WEBPACK_IMPORTED_MODULE_0__["QeSelectors"].blocks.mod.listSelector);
    ...
    QuickESingleton.prototype.initWatchMouse = function () {
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('body').on('mousemove', function (e) {
...
var ToolbarSettings = /** @class */ (function () {
    function ToolbarSettings(defaults) {
        ...
        this.follow = (_a = defaults.follow) !== null && _a !== void 0 ? _a : 'default';
        if (this.follow === 'default')
            this.follow = 'none';
    }
    /**
...
/* harmony import */ var _interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../interfaces/sxc-controller-in-page */ "./src/interfaces/sxc-controller-in-page.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ToolbarConfigFinderAndInitializer = /** @class */ (function (_super) {
    ...
    ToolbarConfigFinderAndInitializer.prototype.buildDnnModule = function (parentTag, optionalId) {
        ...
        parentTag = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__["$jq"])(parentTag || '.DnnModule-' + optionalId);
    ...
    ToolbarConfigFinderAndInitializer.prototype.build = function (node) {
        ...
        var contextNode = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__["$jq"])(node).closest(_constants_index__WEBPACK_IMPORTED_MODULE_0__["C"].Cb.selectors.ofName)[0];
        if (contextNode == null)
            return;
        ...
        var toolbars = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__["$jq"])(toolbarSelector, node);
        toolbars.each(function (i, e) { return _this.loadConfigAndInitialize(e); });
    };
    //////////////////////////////// Private Functions ////////////////////////////////////
    /**
    ...
    ToolbarConfigFinderAndInitializer.prototype.findChildTagsWithConfig = function (parentTag) {
        var allInner = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__["$jq"])(toolbarSelector, parentTag);
        // return only those, which don't belong to a sub-item
        var onlyDirectDescendents = allInner
            .filter(function (i, e) {
            return Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__["$jq"])(e).closest(_constants_index__WEBPACK_IMPORTED_MODULE_0__["C"].Cb.selectors.ofName)[0] === parentTag[0];
        });
        if (dbg)
    ...
    ToolbarConfigFinderAndInitializer.prototype.loadConfigAndInitialize = function (node) {
        ...
        var tag = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_8__["$jq"])(node);
...
var TagToolbarManager = /** @class */ (function () {
    ...
    TagToolbarManager.getBodyScrollOffset = function () {
        var posNoJq = document.body.style.position;
        var body = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])('body');
    ...
    TagToolbarManager.CleanupOrphanedToolbars = function () {
        var tagToolbars = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])("[" + TagToolbarManager.TagToolbarForAttr + "]");
        tagToolbars.each(function (i, e) {
            var id = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])(e).attr(TagToolbarManager.TagToolbarForAttr);
            if (!Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])("[" + TagToolbarManager.TagToolbarAttr + "=" + id + "]").length) {
                Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])(e).remove();
            }
        });
    };
 ...
 */
Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_0__["$jq"])(window).on('mousemove', function (e) {
...
var TagToolbar = /** @class */ (function () {
    ...
    function TagToolbar(hoverTag, context, translator) {
        ...
        this.updateFn = function () { return _this.updatePosition(); };
    ...
    TagToolbar.prototype.initializeIfNecessary = function () {
        ...
        this.toolbarElement = Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(new ___WEBPACK_IMPORTED_MODULE_0__["ToolbarRenderer"](this.context).render());
        ...
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])('body').append(this.toolbarElement);
    ...
    TagToolbar.prototype.updatePosition = function (initial) {
        ...
        var position = {
            ...
            win: {
                ...
                width: Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(window).width(),
            },
        ...
        var trackMouse = (this.follow === 'always')
    ...
    TagToolbar.prototype.activateScrollWatcher = function () {
        if (this.watcherActive)
            return;
        var trackOngoing = this.follow === 'scroll' || this.follow === 'always';
        if (!trackOngoing)
            return;
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(window).on('scroll', this.updateFn);
        if (this.follow === 'always')
            Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(window).on('mousemove', this.updateFn);
    ...
    TagToolbar.prototype.disableScrollWatcher = function () {
        if (!this.watcherActive)
            return;
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(window).off('scroll', this.updateFn);
        Object(_interfaces_sxc_controller_in_page__WEBPACK_IMPORTED_MODULE_1__["$jq"])(window).off('mousemove', this.updateFn);
    };
    return TagToolbar;
}());
