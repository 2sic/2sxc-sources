...
/* harmony import */ var _form_form_config_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../form/form-config.service */ 8265);
/* harmony import */ var _form_form_language_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../form/form-language.service */ 32093);
/* harmony import */ var _localization_language_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../localization/language.service */ 9977);
/* harmony import */ var _center_selected_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./center-selected.helper */ 23873);
/* harmony import */ var _language_switcher_helpers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./language-switcher.helpers */ 11427);
/* harmony import */ var _mouse_scroll_helper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mouse-scroll.helper */ 31289);
/* harmony import */ var _show_shadows_helper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./show-shadows.helper */ 79187);
...
function LanguageSwitcherComponent_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("mousedown", function LanguageSwitcherComponent_For_8_Template_button_mousedown_0_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵresetView"](ctx_r1.lngButtonMouseDown($event));
    })("click", function LanguageSwitcherComponent_For_8_Template_button_click_0_listener($event) {
      const langButton_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r1).$implicit;
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵresetView"](ctx_r1.lngButtonClick($event, langButton_r3));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵproperty"]("color", ctx_r1.current() === langButton_r3.NameId ? "accent" : "white")("tippy", langButton_r3.Culture)("tippyDisabled", ctx_r1.disabled);
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵtextInterpolate1"](" ", langButton_r3.buttonText, " ");
  }
}
class LanguageSwitcherComponent {
  constructor(languageService, languageInstanceService, ngZone, formConfig, snackBar, translate) {
    ...
    this.current = (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.computed)(() => this.formConfig.language().current);
    this.buttons = (0,_language_switcher_helpers__WEBPACK_IMPORTED_MODULE_6__.getLanguageButtons)(this.languageService.getAll());
  }
  ngAfterViewInit() {
    this.showShadowsHelper = new _show_shadows_helper__WEBPACK_IMPORTED_MODULE_8__.ShowShadowsHelper(this.ngZone, this.headerRef.nativeElement, this.leftShadowRef.nativeElement, this.rightShadowRef.nativeElement);
    this.mouseScrollHelper = new _mouse_scroll_helper__WEBPACK_IMPORTED_MODULE_7__.MouseScrollHelper(this.ngZone, this.headerRef.nativeElement, this.areButtonsDisabled.bind(this));
    this.centerSelectedHelper = new _center_selected_helper__WEBPACK_IMPORTED_MODULE_5__.CenterSelectedHelper(this.ngZone, this.headerRef.nativeElement);
  }
  ngOnDestroy() {
  ...
  static {
    this.ɵfac = function LanguageSwitcherComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || LanguageSwitcherComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdirectiveInject"](_localization_language_service__WEBPACK_IMPORTED_MODULE_4__.LanguageService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdirectiveInject"](_form_form_language_service__WEBPACK_IMPORTED_MODULE_3__.FormLanguageService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_9__.NgZone), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdirectiveInject"](_form_form_config_service__WEBPACK_IMPORTED_MODULE_2__.FormConfigService), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_10__.MatSnackBar), _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__.TranslateService));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      viewQuery: function LanguageSwitcherComponent_Query(rf, ctx) {
        ...
        if (rf & 2) {
          let _t;
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵloadQuery"]()) && (ctx.headerRef = _t.first);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵloadQuery"]()) && (ctx.leftShadowRef = _t.first);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵloadQuery"]()) && (ctx.rightShadowRef = _t.first);
        }
      },
      inputs: {
        disabled: "disabled"
      ...
      template: function LanguageSwitcherComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵelement"](1, "div", 4, 0)(3, "div", 5, 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵelementStart"](5, "div", 6, 2);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrepeaterCreate"](7, LanguageSwitcherComponent_For_8_Template, 2, 4, "button", 7, _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrepeaterTrackByIdentity"]);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵelementEnd"]()();
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵproperty"]("tippyDisabled", !ctx.disabled);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵadvance"](2);
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrepeater"](ctx.buttons);
        }
      },
      dependencies: [_angular_material_button__WEBPACK_IMPORTED_MODULE_12__.MatButtonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_12__.MatButton, _shared_directives_tippy_directive__WEBPACK_IMPORTED_MODULE_0__.TippyDirective],
