    ...
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function ContentItemsStatusComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵconditional"](!ctx.disableMetadata ? 4 : -1);
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵconditional"](ctx.disableMetadata && !(!ctx.metadataCount && !ctx.value.metadata) ? 5 : -1);
        }
      },
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! rxjs */ 75797);
...
/* harmony import */ var _shared_components_entity_filter_entity_filter_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/components/entity-filter/entity-filter.component */ 83060);
...
/* harmony import */ var _shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../shared/constants/session.constants */ 38172);
...
/* harmony import */ var _shared_directives_toggle_debug_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../shared/directives/toggle-debug.directive */ 95699);
/* harmony import */ var _shared_fields_data_type_catalog__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../shared/fields/data-type-catalog */ 1726);
...
/* harmony import */ var _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../shared/models/edit-form.model */ 70334);
/* harmony import */ var _shared_modules_sxc_grid_module_sxc_grid_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../shared/modules/sxc-grid-module/sxc-grid.module */ 67037);
...
/* harmony import */ var _shared_services_entity_edit_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../shared/services/entity-edit.service */ 96817);
...
/* harmony import */ var _content_items_actions_content_items_actions_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./content-items-actions/content-items-actions.component */ 10510);
/* harmony import */ var _content_items_entity_content_items_entity_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./content-items-entity/content-items-entity.component */ 49820);
/* harmony import */ var _content_items_status_content_items_status_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./content-items-status/content-items-status.component */ 98826);
/* harmony import */ var _content_items_helpers__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./content-items.helpers */ 3099);
/* harmony import */ var _create_metadata_dialog_create_metadata_dialog_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./create-metadata-dialog/create-metadata-dialog.component */ 28690);
/* harmony import */ var _pub_meta_filter_pub_meta_filter_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./pub-meta-filter/pub-meta-filter.component */ 73138);
/* harmony import */ var _services_content_items_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./services/content-items.service */ 336);
...
function ContentItemsComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Conditional_34_Template_button_click_0_listener() {
...
class ContentItemsComponent {
  ...
  constructor(dialog, snackBar, matDialog, viewContainerRef, changeDetectorRef) {
    ...
    this.isDebug = (0,_angular_core__WEBPACK_IMPORTED_MODULE_27__.inject)(_shared_services_global_config_service__WEBPACK_IMPORTED_MODULE_19__.GlobalConfigService).isDebug;
    this.#entitiesSvc = (0,_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_shared_services_entity_edit_service__WEBPACK_IMPORTED_MODULE_18__.EntityEditService);
    ...
    this.#contentItemsSvc = (0,_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_services_content_items_service__WEBPACK_IMPORTED_MODULE_26__.ContentItemsService);
    ...
    this.#gridApi$ = new rxjs__WEBPACK_IMPORTED_MODULE_28__.BehaviorSubject(null);
    ...
    this.#refresh = (0,_angular_core__WEBPACK_IMPORTED_MODULE_27__.signal)(0);
    this.items = (0,_angular_core__WEBPACK_IMPORTED_MODULE_27__.computed)(() => {
  ...
  fetchColumns() {
    this.#contentItemsSvc.getColumns(this.#contentTypeStaticName).subscribe(columns => {
      ...
      const filterModel = (0,_content_items_helpers__WEBPACK_IMPORTED_MODULE_23__.buildFilterModel)(sessionStorage.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_8__.keyFilters), columnDefs);
      if (this.#gridApi$.value) {
        this.setColumnDefs(columnDefs, filterModel);
      } else {
        this.#gridApi$.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_29__.filter)(gridApi => gridApi != null),
        // firefox does web requests faster than drawing grid and getting gridApi
        (0,rxjs__WEBPACK_IMPORTED_MODULE_30__.take)(1)).subscribe(gridApi => {
          this.setColumnDefs(columnDefs, filterModel);
        });
      }
    });
  ...
  openMetadata(item) {
    const url = _metadata__WEBPACK_IMPORTED_MODULE_3__.GoToMetadata.getUrlEntity(item.Guid, `Metadata for Entity: ${item._Title} (${item.Id})`, this.#contentTypeStaticName);
    this.#dialogRouter.navRelative([url]);
  }
  editItem(item) {
    const form = {
      items: [item == null ? _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_14__.EditPrep.newFromType(this.#contentTypeStaticName) : _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_14__.EditPrep.editId(item.Id)]
    };
  ...
  importContent(files) {
    ...
    this.#dialogRouter.navRelative([`${this.#contentTypeStaticName}/import`], {
      state: dialogData
    });
  }
  importItem(files) {
  ...
  createMetadata() {
    const metadataDialogRef = this.matDialog.open(_create_metadata_dialog_create_metadata_dialog_component__WEBPACK_IMPORTED_MODULE_24__.CreateMetadataDialogComponent, {
      autoFocus: false,
    ...
    metadataDialogRef.afterClosed().subscribe(itemFor => {
      ...
      const form = {
        items: [_shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_14__.EditPrep.newMetadataFromInfo(this.#contentTypeStaticName, itemFor)]
      };
      const formUrl = (0,_shared_helpers_url_prep_helper__WEBPACK_IMPORTED_MODULE_12__.convertFormToUrl)(form);
      this.#dialogRouter.navRelative([`edit/${formUrl}`]);
  ...
  buildColumnDefs(columns) {
    const columnDefs = [{
      ...
      filter: _pub_meta_filter_pub_meta_filter_component__WEBPACK_IMPORTED_MODULE_25__.PubMetaFilterComponent,
      valueGetter: p => {
        const item = p.data;
        const published = {
      ...
      cellRenderer: _content_items_status_content_items_status_component__WEBPACK_IMPORTED_MODULE_22__.ContentItemsStatusComponent,
      cellRendererParams: (() => {
        const params = {
      ...
      field: '_Title',
      flex: 2,
      onCellClicked: p => this.editItem(p.data)
    }, {
      headerName: 'Stats',
      ...
      cellRenderer: _content_items_actions_content_items_actions_component__WEBPACK_IMPORTED_MODULE_20__.ContentItemsActionsComponent,
      cellRendererParams: (() => {
        const params = {
          do: (verb, item) => {
            switch (verb) {
    ...
    for (const column of columns) {
      ...
      switch (column.Type) {
        case _shared_fields_data_type_catalog__WEBPACK_IMPORTED_MODULE_11__.DataTypeCatalog.Entity:
          colDef.allowMultiValue = column.Metadata?.Entity?.AllowMultiValue ?? true;
          colDef.cellRenderer = _content_items_entity_content_items_entity_component__WEBPACK_IMPORTED_MODULE_21__.ContentItemsEntityComponent;
          colDef.valueGetter = this.valueGetterEntityField;
          colDef.filter = _shared_components_entity_filter_entity_filter_component__WEBPACK_IMPORTED_MODULE_6__.EntityFilterComponent;
          break;
        case _shared_fields_data_type_catalog__WEBPACK_IMPORTED_MODULE_11__.DataTypeCatalog.DateTime:
          colDef.useTimePicker = column.Metadata?.DateTime?.UseTimePicker ?? false;
          colDef.valueGetter = this.valueGetterDateTime;
          colDef.filter = 'agTextColumnFilter';
          break;
        case _shared_fields_data_type_catalog__WEBPACK_IMPORTED_MODULE_11__.DataTypeCatalog.Boolean:
          colDef.valueGetter = this.valueGetterBoolean;
          colDef.filter = _shared_components_boolean_filter_boolean_filter_component__WEBPACK_IMPORTED_MODULE_5__.BooleanFilterComponent;
          break;
        case _shared_fields_data_type_catalog__WEBPACK_IMPORTED_MODULE_11__.DataTypeCatalog.Number:
  ...
  clone(item) {
    const form = {
      items: [_shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_14__.EditPrep.copy(this.#contentTypeStaticName, item.Id)]
    };
    const formUrl = (0,_shared_helpers_url_prep_helper__WEBPACK_IMPORTED_MODULE_12__.convertFormToUrl)(form);
    this.#dialogRouter.navRelative([`edit/${formUrl}`]);
  }
  ...
  static {
    this.ɵfac = function ContentItemsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || ContentItemsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_31__.MatDialogRef), _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_32__.MatSnackBar), _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_31__.MatDialog), _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_27__.ViewContainerRef), _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_27__.ChangeDetectorRef));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵdefineComponent"]({
      ...
      standalone: true,
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵStandaloneFeature"]],
      decls: 38,
      vars: 6,
      ...
      template: function ContentItemsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Template_button_click_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵtemplate"](9, ContentItemsComponent_Conditional_9_Template, 2, 3, "div", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵelementStart"](10, "div", 6)(11, "ag-grid-angular", 7);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("gridReady", function ContentItemsComponent_Template_ag_grid_angular_gridReady_11_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Template_button_click_14_listener() {
            return ctx.exportContent();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Template_button_click_19_listener() {
            return ctx.importContent();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Template_button_click_24_listener() {
            return ctx.importItem();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Template_button_click_29_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵtemplate"](34, ContentItemsComponent_Conditional_34_Template, 5, 0, "button", 15);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵelementStart"](35, "button", 16);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵlistener"]("click", function ContentItemsComponent_Template_button_click_35_listener() {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵtextInterpolate1"]("", ((tmp_0_0 = ctx.contentType()) == null ? null : tmp_0_0.Label) || ((tmp_0_0 = ctx.contentType()) == null ? null : tmp_0_0.Name), " Data");
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵadvance"](6);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵconditional"]((tmp_1_0 = (tmp_1_0 = ctx.contentType()) == null ? null : tmp_1_0.Properties == null ? null : tmp_1_0.Properties.ListInstructions) ? 9 : -1, tmp_1_0);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵadvance"](2);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵproperty"]("rowData", ctx.items()())("gridOptions", ctx.gridOptions)("allowedFileTypes", "xml,json");
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵadvance"](23);
          _angular_core__WEBPACK_IMPORTED_MODULE_27__["ɵɵconditional"](ctx.isDebug() ? 34 : -1);
        }
      },
      dependencies: [_angular_material_button__WEBPACK_IMPORTED_MODULE_33__.MatButtonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_33__.MatButton, _angular_material_button__WEBPACK_IMPORTED_MODULE_33__.MatIconButton, _angular_material_button__WEBPACK_IMPORTED_MODULE_33__.MatFabButton, _angular_material_icon__WEBPACK_IMPORTED_MODULE_34__.MatIconModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_34__.MatIcon, _angular_router__WEBPACK_IMPORTED_MODULE_35__.RouterOutlet, _angular_material_dialog__WEBPACK_IMPORTED_MODULE_31__.MatDialogActions, _shared_pipes_safe_html_pipe__WEBPACK_IMPORTED_MODULE_16__.SafeHtmlPipe, _shared_directives_drag_and_drop_directive__WEBPACK_IMPORTED_MODULE_9__.DragAndDropDirective, _shared_directives_toggle_debug_directive__WEBPACK_IMPORTED_MODULE_10__.ToggleDebugDirective, _shared_modules_sxc_grid_module_sxc_grid_module__WEBPACK_IMPORTED_MODULE_15__.SxcGridModule, _ag_grid_community_angular__WEBPACK_IMPORTED_MODULE_36__.AgGridAngular],
      encapsulation: 2
    });
  }
}
...
function CreateMetadataDialogComponent_Conditional_0_Conditional_27_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_14__["ɵɵproperty"]("value", contentType_r6.StaticName);
    _angular_core__WEBPACK_IMPORTED_MODULE_14__["ɵɵadvance"]();
...
function CreateMetadataDialogComponent_Conditional_0_Conditional_36_Case_1_Conditional_0_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_14__["ɵɵproperty"]("value", contentType_r9.StaticName);
    _angular_core__WEBPACK_IMPORTED_MODULE_14__["ɵɵadvance"]();
...
/* harmony import */ var _services_service_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/service-base */ 4979);
 ...
 */
class DialogRoutingService extends _services_service_base__WEBPACK_IMPORTED_MODULE_0__.ServiceBase {
  ...
  navParentFirstChild(commands, extras) {
    return this.router.navigate(commands, {
      ...extras,
