...
class SelectorWithHelpComponent {
  constructor(dialog) {
    this.dialog = dialog;
    this.label = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.items = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.valueInput = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.value = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.signal)('');
    this.valueChange = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.output)();
  }
  ngOnInit() {
