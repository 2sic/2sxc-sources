...
class DataBundlesDetailComponent {
  ...
  constructor(dialog, route) {
    this.dialog = dialog;
    this.route = route;
    this.#dataBundlesService = (0,projects_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_data_bundles_query_service__WEBPACK_IMPORTED_MODULE_4__.DataBundlesService);
  ...
  ngOnInit() {
    ...
    }), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.switchMap)(params => this.#dataBundlesService.fetchQuery(params.guid)), (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.tap)(d => this.dataBundles.set(d))).subscribe();
  }
  closeDialog() {
    this.dialog.close();
  }
