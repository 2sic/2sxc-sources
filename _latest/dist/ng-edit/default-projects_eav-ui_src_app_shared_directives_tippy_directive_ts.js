...
class TippyDirective {
  ...
  ngOnChanges(changes) {
    ...
    if (changes['tippy'] != null || changes['tippyTranslate'] != null || changes['tippyFontSize'] != null) {
      const contents = this.tippyTranslate ? this.translate?.instant(this.tippyTranslate) ?? this.tippyTranslate // temp with null-check in case the service is missing ATM
      : this.tippy ?? '';
      if (!contents) this.#tooltip.disable();
  ...
  static {
    this.ɵfac = function TippyDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || TippyDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__.TranslateService, 8));
    };
  }
  static {
