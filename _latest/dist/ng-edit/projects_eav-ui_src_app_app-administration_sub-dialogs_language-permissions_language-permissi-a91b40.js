...
class LanguagePermissionsComponent {
  ...
  constructor(dialog) {
    ...
    this.languages = (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.signal)([]);
    this.#zoneService = (0,_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_apps_management_services_zone_service__WEBPACK_IMPORTED_MODULE_1__.ZoneService);
