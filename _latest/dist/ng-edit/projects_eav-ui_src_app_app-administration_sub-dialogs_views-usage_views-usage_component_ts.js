...
class ViewsUsageComponent {
  constructor(dialog, route) {
    ...
    this.viewUsage = (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.signal)(undefined);
    this.viewTooltip = (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.signal)(undefined);
    this.data = (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.signal)(undefined);
  ...
  ngOnInit() {
    ...
    this.viewsService.getUsage(viewGuid).subscribe(viewUsages => {
      ...
      const data = (0,_views_usage_helpers__WEBPACK_IMPORTED_MODULE_9__.buildData)(viewUsage);
      this.data.set(data);
    });
  }
  closeDialog() {
    ...
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
      ...
      template: function ViewsUsageComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵproperty"]("tippy", ctx.viewTooltip());
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵadvance"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵtextInterpolate1"]("View: ", (tmp_1_0 = ctx.viewUsage()) == null ? null : tmp_1_0.Name, "");
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵadvance"](13);
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵproperty"]("rowData", ctx.data())("gridOptions", ctx.gridOptions);
        }
      },
