...
function QueriesRestApiComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrepeater"](ctx.sort());
  }
}
class QueriesRestApiComponent {
  ...
  constructor(fb) {
    ...
    this.queryTypes$ = new rxjs__WEBPACK_IMPORTED_MODULE_6__.BehaviorSubject(undefined);
  }
  ngOnInit() {
    this.fetchQueries();
  ...
  fetchQueries() {
    this.#pipelinesSvc.getAll(_shared_constants_eav_constants__WEBPACK_IMPORTED_MODULE_1__.eavConstants.contentTypes.query).subscribe(queries => {
  ...
  static {
    this.ɵfac = function QueriesRestApiComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || QueriesRestApiComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormBuilder));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
      ...
      template: function QueriesRestApiComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵconditional"]((tmp_1_0 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](6, 2, ctx.queryTypes$)) ? 5 : -1, tmp_1_0);
        }
      },
