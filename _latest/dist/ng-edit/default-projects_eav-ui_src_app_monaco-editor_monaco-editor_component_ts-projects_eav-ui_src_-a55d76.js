"use strict";
(self["webpackChunkeav_ui"] = self["webpackChunkeav_ui"] || []).push([["default-projects_eav-ui_src_app_monaco-editor_monaco-editor_component_ts-projects_eav-ui_src_-a55d76"],{
...
class MonacoEditorComponent {
  ...
  static #_ = this.ɵfac = function MonacoEditorComponent_Factory(t) {
    return new (t || MonacoEditorComponent)();
  };
...
class MonacoInstance {
  ...
  defineThemes(globalCache, monaco) {
    ...
    if (globalCache.themesAreDefined) {
      return;
    }
  ...
  addSnippets(monaco, editorInstance) {
    const completionItemProviders = [monaco.languages.registerCompletionItemProvider(editorInstance.getModel().getLanguageId(), {
      ...
      provideHover: (model, position) => {
        if (this.tooltips == null || editorInstance.getModel() !== model) {
          return;
        }
...
//# sourceMappingURL=default-projects_eav-ui_src_app_monaco-editor_monaco-editor_component_ts-projects_eav-ui_src_-a55d76.js.map