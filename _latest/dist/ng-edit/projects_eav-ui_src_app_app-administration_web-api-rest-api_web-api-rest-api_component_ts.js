...
function WebApiRestApiComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrepeater"](ctx_r1.webApisTypes().sort());
  }
}
class WebApiRestApiComponent {
  ...
  constructor(fb) {
    ...
    this.webApisTypes = (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.computed)(() => {
  ...
  static {
    this.ɵfac = function WebApiRestApiComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || WebApiRestApiComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormBuilder));
    };
  }
  static {
