...
/* harmony import */ var _sub_dialogs_import_query_import_query_dialog_config__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./sub-dialogs/import-query/import-query-dialog.config */ 12541);
/* harmony import */ var _sub_dialogs_import_view_import_view_dialog_config__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./sub-dialogs/import-view/import-view-dialog.config */ 61311);
/* harmony import */ var _sub_dialogs_language_permissions_language_permissions_dialog_config__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./sub-dialogs/language-permissions/language-permissions-dialog.config */ 81999);
/* harmony import */ var _sub_dialogs_views_usage_views_usage_dialog_config__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./sub-dialogs/views-usage/views-usage-dialog.config */ 63991);
...
const appAdministrationRoutes = [{
  ...
  children: [{
    ...
    children: [{
      ...
      component: _shared_components_dialog_entry_dialog_entry_component__WEBPACK_IMPORTED_MODULE_6__.DialogEntryComponent,
      data: {
        dialog: _sub_dialogs_import_query_import_query_dialog_config__WEBPACK_IMPORTED_MODULE_22__.importQueryDialog,
        title: 'Import Query'
      }
    ...
    children: [{
      ...
      component: _shared_components_dialog_entry_dialog_entry_component__WEBPACK_IMPORTED_MODULE_6__.DialogEntryComponent,
      data: {
        dialog: _sub_dialogs_import_view_import_view_dialog_config__WEBPACK_IMPORTED_MODULE_23__.importViewDialog,
        title: 'Import View'
      }
    }, {
      path: 'usage/:guid',
      component: _shared_components_dialog_entry_dialog_entry_component__WEBPACK_IMPORTED_MODULE_6__.DialogEntryComponent,
      data: {
        dialog: _sub_dialogs_views_usage_views_usage_dialog_config__WEBPACK_IMPORTED_MODULE_25__.viewsUsageDialog
      }
    }, ..._edit_edit_routing__WEBPACK_IMPORTED_MODULE_1__.EditRoutes, {
      ..._permissions_go_to_permissions__WEBPACK_IMPORTED_MODULE_5__.GoToPermissions.route,
      data: {
    ...
    ..._edit_edit_routing__WEBPACK_IMPORTED_MODULE_1__.EditRoutes, {
      ...
      component: _shared_components_dialog_entry_dialog_entry_component__WEBPACK_IMPORTED_MODULE_6__.DialogEntryComponent,
      data: {
        dialog: _sub_dialogs_language_permissions_language_permissions_dialog_config__WEBPACK_IMPORTED_MODULE_24__.languagePermissionsDialog,
...
class DataBundlesService {
  ...
  static {
    this.ɵfac = function DataBundlesService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || DataBundlesService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__.TranslateService));
    };
  }
  static {
...
/* harmony import */ var _data_bundles_actions_data_bundles_actions_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./data-bundles-actions/data-bundles-actions.component */ 40076);
/* harmony import */ var _data_bundles_query_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./data-bundles-query.service */ 84242);
...
class DataBundlesComponent {
  ...
  constructor() {
    this.#contentItemsSvc = (0,projects_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_content_items_services_content_items_service__WEBPACK_IMPORTED_MODULE_2__.ContentItemsService);
    this.#contentExportSvc = (0,projects_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_content_export_services_content_export_service__WEBPACK_IMPORTED_MODULE_1__.ContentExportService);
    this.#dialogRouter = (0,projects_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_shared_routing_dialog_routing_service__WEBPACK_IMPORTED_MODULE_10__.DialogRoutingService);
    this.#dataBundlesService = (0,projects_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_data_bundles_query_service__WEBPACK_IMPORTED_MODULE_12__.DataBundlesService);
    ...
    this.dataBundles = (0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.computed)(() => {
    ...
    this.#queryResults = (0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.signal)([]);
    this.#queryData = (0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.computed)(() => {
    ...
    this.dataSourceData = (0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.computed)(() => {
      const dataBundles = this.dataBundles()() || [];
  ...
  editItem(item) {
    const form = {
      items: [item == null ? _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_8__.EditPrep.newFromType(this.#defaultContentTypeId) : _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_8__.EditPrep.editId(item.Id)]
    };
  ...
  #buildGridOptions() {
    const gridOptions = {
      ...
      columnDefs: [{
        ...
        field: 'Name',
        flex: 2,
        cellRenderer: p => _shared_ag_grid_ag_grid_helper__WEBPACK_IMPORTED_MODULE_4__.AgGridHelper.cellLink('#' + this.#dialogRouter.urlSubRoute(`details/${p.data.Guid}/${p.data.Name}`), p.data.Name)
      }, {
        ..._shared_ag_grid_column_definitions__WEBPACK_IMPORTED_MODULE_5__.ColumnDefinitions.TextWideMin100,
        headerName: 'File-Name',
        field: 'FileName'
      }, {
        ..._shared_ag_grid_column_definitions__WEBPACK_IMPORTED_MODULE_5__.ColumnDefinitions.Number2,
        headerName: 'Entities',
        field: 'Entities'
      }, {
        ..._shared_ag_grid_column_definitions__WEBPACK_IMPORTED_MODULE_5__.ColumnDefinitions.Number2,
        ...
        cellRenderer: _data_bundles_actions_data_bundles_actions_component__WEBPACK_IMPORTED_MODULE_11__.DataBundleActionsComponent,
        cellRendererParams: {
          do: (verb, item) => {
            switch (verb) {
              case 'edit':
  ...
  static {
    this.ɵfac = function DataBundlesComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || DataBundlesComponent)();
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
      ...
      decls: 25,
      vars: 5,
      consts: [[1, "outer-container-app"], [3, "featureNameId"], [1, "grid-height"], [1, "grid-wrapper", "mat-tab-grid-wrapper"], [1, "ag-theme-material", 3, "rowData", "gridOptions"], [1, "fab-button-pos"], ["mat-fab", "", "mat-elevation-z24", "", "tippy", "Add item", 1, "grid-fab", 3, "click"]],
      template: function DataBundlesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](2, "Data Bundles (BETA)");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](3, "p");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](4, " Data Bundles are a new feature which allow you to mark parts of your app as a bundle, and then export/import them. This allows you to do a partial sync of data and schema between environments. ");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelement"](5, "app-feature-text-info", 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](6, "h3");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](7, "Bundle Export Configurations");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](8, "p");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](9, " Bundles must be defined by creating a ");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](10, "strong");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](11, "Bundle Configuration");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](12, ", and then assigning Content-Types and Data to that configuration. ");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](13, "div", 2)(14, "div", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelement"](15, "ag-grid-angular", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](16, "div", 5)(17, "button", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function DataBundlesComponent_Template_button_click_17_listener() {
            return ctx.editItem(null);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]()()();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](20, "h3");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](21, "Import Bundles");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](22, "p");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtext"](23, "To import a bundle, TODO... Note that all data and schema will be overwritten by the imported data in the bundle.");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelement"](24, "router-outlet");
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵproperty"]("featureNameId", "DataExportImportBundles");
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵadvance"](8);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵstyleMap"](ctx.height);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵadvance"](2);
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵproperty"]("rowData", ctx.dataSourceData())("gridOptions", ctx.gridOptions);
        }
      },
      dependencies: [_features_feature_text_info_feature_text_info_component__WEBPACK_IMPORTED_MODULE_3__.FeatureTextInfoComponent, _shared_modules_sxc_grid_module_sxc_grid_module__WEBPACK_IMPORTED_MODULE_9__.SxcGridModule, _ag_grid_community_angular__WEBPACK_IMPORTED_MODULE_14__.AgGridAngular, _angular_material_button__WEBPACK_IMPORTED_MODULE_15__.MatButtonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_15__.MatFabButton, _angular_material_icon__WEBPACK_IMPORTED_MODULE_16__.MatIconModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_16__.MatIcon, _angular_router__WEBPACK_IMPORTED_MODULE_17__.RouterModule, _angular_router__WEBPACK_IMPORTED_MODULE_17__.RouterOutlet],
      styles: [".grid-height[_ngcontent-%COMP%] {\n  max-height: calc(100vh - 560px);\n  min-height: 135px;\n}\n\n.fab-button-pos[_ngcontent-%COMP%] {\n  margin-top: 8px;\n  display: flex;\n  justify-content: end;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class ExportAppPartsComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      styles: [".eav-edit-input[_ngcontent-%COMP%] {\n  padding-bottom: 8px;\n}\n\n.eav-content-info__title[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: bold;\n}\n.eav-content-info__subtitle[_ngcontent-%COMP%] {\n  font-size: 14px;\n  font-weight: bold;\n}\n.eav-content-info__list[_ngcontent-%COMP%] {\n  font-size: 14px;\n  list-style-type: none;\n}\n.eav-content-info__base[_ngcontent-%COMP%] {\n  padding: 0;\n}\n.eav-content-info__item[_ngcontent-%COMP%] {\n  border-top: 1px solid #ddd;\n  padding: 2px;\n}\n\n.eav-option-box[_ngcontent-%COMP%] {\n  margin: 8px 0;\n}\n.eav-option-box__text[_ngcontent-%COMP%] {\n  white-space: normal;\n  font-size: 14px;\n}\n\n.form-height[_ngcontent-%COMP%] {\n  max-height: calc(100vh - 24px - 56px - 200px);\n  overflow: auto;\n}\n\n.enable[_ngcontent-%COMP%] {\n  pointer-events: all;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class ExportAppComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      styles: [".eav-app-info__title[_ngcontent-%COMP%] {\n  font-size: 18px;\n  margin: 24px 0 0;\n  font-weight: bold;\n}\n.eav-app-info__content[_ngcontent-%COMP%] {\n  font-size: 14px;\n}\n.eav-app-info__content[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  padding: 2px 0;\n}\n\n.eav-options-wrapper[_ngcontent-%COMP%] {\n  margin: 24px 0;\n}\n\n.eav-option-box[_ngcontent-%COMP%] {\n  margin: 2px 0;\n}\n.eav-option-box__text[_ngcontent-%COMP%] {\n  white-space: normal;\n  font-size: 14px;\n}\n\n.form-height[_ngcontent-%COMP%] {\n  max-height: calc(100vh - 24px - 48px - 200px);\n  overflow: auto;\n}\n\n.mdc-form-field[_ngcontent-%COMP%]    > label[_ngcontent-%COMP%] {\n  padding-top: 12px;\n}\n\nul.checkboxes[_ngcontent-%COMP%] {\n  list-style-type: none;\n  margin-top: 4px;\n  padding-left: 0;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
Please try again later or check how to manually install content-templates: https://azing.org/2sxc/r/0O4OymoA`;
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      styles: [".eav-result-container[_ngcontent-%COMP%] {\n  margin-top: 16px;\n  max-height: calc(100vh - 74px - 23px - 57px - 200px);\n  overflow-y: auto;\n}\n\n.eav-app-catalog-button[_ngcontent-%COMP%] {\n  margin-left: 12px;\n}\n\n.eav-app-catalog-iframe[_ngcontent-%COMP%] {\n  margin-top: 16px;\n  width: 100%;\n  height: 500px;\n  border: none;\n}\n\n.eav-progress[_ngcontent-%COMP%] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  height: 100%;\n  width: 100%;\n  background: rgba(255, 255, 255, 0.8);\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  text-align: center;\n}\n.eav-progress[_ngcontent-%COMP%]   mat-progress-spinner[_ngcontent-%COMP%] {\n  margin: 0 auto;\n}\n.eav-progress[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  line-height: 48px;\n}\n\n.select-btn[_ngcontent-%COMP%] {\n  margin-bottom: 12px;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class ImportExportComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      styles: ["a[_ngcontent-%COMP%] {\n  color: black;\n  text-decoration: none;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
