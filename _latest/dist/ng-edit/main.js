...
function paramsInitFactory(injector) {
  ...
  return () => {
    ...
    const eavKeys = Object.keys(s).filter(key => key.startsWith(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.prefix));
    ...
    if (isParamsRoute) {
      ...
      for (const key of eavKeys) s.removeItem(key);
      // save url which opened the dialog and set edit dialog as the default
      s.setItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyUrl, window.location.href);
      s.setItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyDialog, _shared_constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Edit);
      ...
      const dialog = s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyDialog);
      const contentType = s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyContentType);
      const items = s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyItems);
      // const getZoneFull = () => `${zoneId}/v2/${s.getItem(keyModuleId)}/${s.getItem(keyContentBlockId)}`;
      // const getZoneApp = () => `${zoneId}/${appId}`;
      const getFull = () => `${s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyZoneId)}/v2/${s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyModuleId)}/${s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyContentBlockId)}/${s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyAppId)}`;
      l.a('dialog: ' + dialog);
      switch (dialog) {
        case _shared_constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Zone:
          const extrasZone = JSON.parse(s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyExtras));
        ...
        case _shared_constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.App:
          const extrasApp = JSON.parse(s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyExtras));
        ...
        case _shared_constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.PipelineDesigner:
          const pipelineId = s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyPipelineId);
      ...
      // Log initial route so a developer can re-open the dialog with the link in the console
      logInitialRoute(s.getItem(_shared_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyUrl));
    }
  };
}
...
/* harmony export */   languageUi: () => (/* binding */ languageUi),
...
const languageUi = prefix + 'languageui';
const languageLabels = prefix + 'languagelabels';
