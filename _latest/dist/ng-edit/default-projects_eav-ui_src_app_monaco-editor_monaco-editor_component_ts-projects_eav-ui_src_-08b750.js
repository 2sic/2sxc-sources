...
class MonacoEditorComponent {
  constructor() {
    this.filename = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.value = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.tooltips = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.snippets = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.options = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.jsonSchema = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.jsonComments = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.jsTypings = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.jsDiagnostics = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)();
    this.autoFocus = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.input)(false);
    this.valueChanged = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.output)();
    this.focused = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.output)();
    this.blurred = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.output)();
  }
  ngAfterViewInit() {
