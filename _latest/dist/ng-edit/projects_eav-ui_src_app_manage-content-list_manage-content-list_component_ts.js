...
class ManageContentListComponent {
  ...
  constructor(dialog, snackBar, translate) {
    ...
    this.header = (0,_shared_signals_signal_utilities__WEBPACK_IMPORTED_MODULE_7__.signalObj)('header', null);
  ...
  #fetchHeader() {
    this.#contentGroupSvc.getHeader(this.#contentGroup).subscribe(header => this.header.set(header));
  }
  static {
