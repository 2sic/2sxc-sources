...
*/
var SxcDataQueryBase = /** @class */ (function () {
    /**
...
var SxcQuery = /** @class */ (function (_super) {
     ...
     * @memberof SxcQuery
     */
    SxcQuery.prototype.getStream = function (stream) {
        if (stream.indexOf(',') !== -1)
            throw "parameter 'stream' can only contain one stream name for 'getStream'";
        return this.getInternal(stream).then(function (data) {
...
/* harmony import */ var _constants_ids__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../constants/ids */ "./src/constants/ids.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var BootstrapInPage = /** @class */ (function (_super) {
    ...
    BootstrapInPage.prototype.initAllInstances = function (isFirstRun) {
        ...
        document.querySelectorAll('div[data-edit-context]').forEach(function (e) {
        ...
        var observer = new MutationObserver(function (m) {
            ...
            m.forEach(function (v) {
                v.addedNodes.forEach(function (n) {
                    ...
                    if (node.matches(_constants_ids__WEBPACK_IMPORTED_MODULE_10__["IDs"].cls.scMenu))
                        return;
                    processed++;
                    ...
                    else if (node.matches(':not(.active-module)') && node.querySelectorAll('div[data-edit-context]').length > 0) {
                        node.querySelectorAll('div[data-edit-context]').forEach(function (e) {
    ...
    BootstrapInPage.prototype.tryShowTemplatePicker = function () {
        ...
        if (openDialogId) {
            ...
            var found = document.querySelectorAll("[data-cb-id=\"" + openDialogId + "\"]");
            if (found.length) {
        ...
        if (!sxc) {
            var uninitializedModules = document.querySelectorAll('.sc-uninitialized');
            ...
            var module_1 = (_a = Array.from(uninitializedModules).find(function (e) { return e.parentElement.matches('div[data-edit-context]'); })) === null || _a === void 0 ? void 0 : _a.parentElement;
    ...
    BootstrapInPage.prototype.showGlassesButtonIfUninitialized = function (sxci) {
        ...
        if (tag.querySelectorAll('.sc-uninitialized').length !== 0)
            return callLog.return(false, 'already has button');
        // note: title is added on mouseover, as the translation isn't ready at page-load
        var btn = _plumbing__WEBPACK_IMPORTED_MODULE_5__["NoJQ"].domFromString('<div class="sc-uninitialized" onmouseover="this.title = $2sxc.translate(this.title)" title="InPage.NewElement">' +
...
/* harmony import */ var _logging__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../logging */ "./src/logging/index.ts");
/* harmony import */ var _commands_engine_run_params__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../commands/engine/run-params */ "./src/commands/engine/run-params.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var Cms = /** @class */ (function (_super) {
    ...
    Cms.prototype.run = function (context, nameOrSettings, eventOrSettings, event) {
        ...
        var cmsEngine = new _commands___WEBPACK_IMPORTED_MODULE_0__["CmsEngine"](this.log);
        // Figure out inner-call based on if context is new RunParams or not (in that case it should be a tag or a full context)
        var innerCall;
        if (Object(_commands_engine_run_params__WEBPACK_IMPORTED_MODULE_5__["isRunParams"])(context)) {
            // todo
            var realCtx_1 = _context_bundles_context_bundle_button__WEBPACK_IMPORTED_MODULE_2__["ContextComplete"].findContext(context.tag);
            ...
            var realCtx_2 = _context_bundles_context_bundle_instance__WEBPACK_IMPORTED_MODULE_3__["ContextBundleInstance"].is(context)
                ? context
...
/* harmony import */ var _run_parameters__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./run-parameters */ "./src/commands/engine/run-parameters.ts");
/* harmony import */ var _workflow_workflow_manager__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../workflow/workflow-manager */ "./src/workflow/workflow-manager.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var CmsEngine = /** @class */ (function (_super) {
    ...
    function CmsEngine(parentLog) {
        ...
        _this.runParamsHelper = new _run_parameters__WEBPACK_IMPORTED_MODULE_9__["RunParametersHelper"](_this.log);
        return _this;
    }
    ...
    CmsEngine.prototype.run = function (context, nameOrParams, event, wipParamsWithWorkflow) {
        ...
        if (wipParamsWithWorkflow && wipParamsWithWorkflow.workflows) {
            wf = new _workflow_workflow_manager__WEBPACK_IMPORTED_MODULE_10__["WorkflowManager"](this.log);
...
/*!*******************************************!*\
  !*** ./src/commands/engine/run-params.ts ***!
  \*******************************************/
/*! exports provided: isRunParams */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isRunParams", function() { return isRunParams; });
function isRunParams(maybeRunParams) {
...
var SxcEdit = /** @class */ (function (_super) {
    ...
    SxcEdit.getContainerTag = function (htmlTag) {
        return htmlTag.closest('div[data-edit-context]');
    };
    /**
    ...
    SxcEdit.getTag = function (sxci) {
        return document.querySelector("div[data-cb-id='" + sxci.cbid + "']");
    };
    return SxcEdit;
...
var Manage = /** @class */ (function () {
    ...
    Manage.prototype.initInstance = function (sxc) {
        try {
            ...
            var editManager = new _edit_manager__WEBPACK_IMPORTED_MODULE_4__["EditManager"](myContext.sxc, editContext, userInfo, cmdEngine, myContext);
...
var QuickEClipboard = /** @class */ (function (_super) {
    ...
    function QuickEClipboard() {
        ...
        _logging__WEBPACK_IMPORTED_MODULE_1__["NoJQ"].ready(function () { return _this.initializeSecondaryButtons(); });
        return _this;
    }
    /** Singleton */
    ...
    QuickEClipboard.prototype.setSecondaryActionsState = function (state) {
        ...
        btns.forEach(function (btn) { return btn.classList.toggle('sc-unavailable', !state); });
        cl.done();
    };
    QuickEClipboard.prototype.createSpecs = function (type, list, domIndex) {
        ...
        var contextInfo = _context_for_lists__WEBPACK_IMPORTED_MODULE_2__["ContextForLists"].getFromDom(list) || {
            parent: 'dnn',
            field: list.id,
            parentGuid: null,
        };
...
(function (QuickEditOverlay) {
    ...
    QuickEditOverlay.selectedOverlay = _plumbing__WEBPACK_IMPORTED_MODULE_1__["NoJQ"].domFromString('<div class="sc-content-block-menu sc-content-block-selected-menu sc-i18n"></div>').map(function (o) {
        o.append(_plumbing__WEBPACK_IMPORTED_MODULE_1__["NoJQ"].domFromString(QuickEditOverlay.btn('delete', 'trash-empty', 'Delete'))[0], _plumbing__WEBPACK_IMPORTED_MODULE_1__["NoJQ"].domFromString(QuickEditOverlay.btn('sendToPane', 'move', 'Move', null, null, 'sc-cb-mod-only'))[0], _plumbing__WEBPACK_IMPORTED_MODULE_1__["NoJQ"].domFromString('<div id="paneList"></div>')[0]);
        return o;
    })[0];
