...
var ToSxcName = "2sxc";
/** @internal */
var constants_SxcVersion = "16.00.01";
/** @internal */
    ...
    Command.prototype.mergeDefaults = function (translateKey, icon, uiOnly, partOfPage, more) {
        ...
        this.buttonDefaults = command_assign({ icon: function () { return "".concat(iconPrefix).concat(icon); }, title: function () { return "".concat(tlbI18nPrefix).concat(translateKey); }, uiActionOnly: function () { return uiOnly; }, partOfPage: function () { return partOfPage; }, color: function () { return undefined; }, tippy: function (ctx, tag) {
                ...
                if (!(note === null || note === void 0 ? void 0 : note.note))
                    return undefined;
                tippy_esm(tag, {
                    content: note === null || note === void 0 ? void 0 : note.note,
                    theme: 'light',
                    arrow: true,
                    delay: [null, null],
                    allowHTML: (_b = note === null || note === void 0 ? void 0 : note.allowHtml) !== null && _b !== void 0 ? _b : false,
 ...
 * @internal
 */
function getToolbarWhenNoneProvided(errorCode) {
    var toolbar = [ToolbarSettings.getForEmptyAsRule()];
    // we have an error code, so we should add the insights button
    if (errorCode)
        toolbar.push("insights&color=red&pos=10&note=".concat(Note.toJson64String({
...
function addDefaultToolbarConfigToTag(parentTag) {
    ...
    if (ctx.ui.autoToolbar === false)
        return null;
    contentTag.setAttribute(C.Toolbar.attr.full, JSON.stringify(getToolbarWhenNoneProvided((_a = ctx === null || ctx === void 0 ? void 0 : ctx.system) === null || _a === void 0 ? void 0 : _a.error)));
    return [contentTag];
}
...
var command_edit_assign = (undefined && undefined.__assign) || function () {
    command_edit_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return command_edit_assign.apply(this, arguments);
};
...
Commands.add("edit" /* CommandNames.edit */, 'Edit', 'pencil', false, true, {
    addParamsToLink: function (ctx) { return (command_edit_assign({ mode: "edit" /* CommandNames.edit */ }, (ctx.button.command.params.fields ? { fields: ctx.button.command.params.fields } : {}))); },
    showCondition: function (ctx) {
...
var command_info_assign = (undefined && undefined.__assign) || function () {
    command_info_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return command_info_assign.apply(this, arguments);
};
...
function getNote(ctx) {
    var _a, _b, _c;
    var note = (_b = (_a = ContextComplete.getRule(ctx)) === null || _a === void 0 ? void 0 : _a.ui) === null || _b === void 0 ? void 0 : _b.note;
    if (!note)
        return { type: 'info', note: null };
    note.type = (_c = note.type) !== null && _c !== void 0 ? _c : 'info'; // type can be null, in which case a simple spread operator would not set the default value
    return command_info_assign({ type: 'info' }, note);
}
/**
 * import this module to commands.ts
 * @internal
...
Commands.add("info" /* CommandNames.info */, 'Info', 'info', true, false, {
    icon: function (ctx) { var _a; return iconPrefix + ((_a = getNote(ctx)) === null || _a === void 0 ? void 0 : _a.type); },
    title: function (ctx) { var _a, _b; return tlbI18nPrefix + ((_b = i18nKeys[(_a = getNote(ctx)) === null || _a === void 0 ? void 0 : _a.type]) !== null && _b !== void 0 ? _b : 'Info'); },
    color: function (ctx) { var _a, _b; return colors[(_b = (_a = getNote(ctx)) === null || _a === void 0 ? void 0 : _a.type) !== null && _b !== void 0 ? _b : 'info']; },
    code: function (context, event) {
        var params = context.button.command.params;
        if (params === null || params === void 0 ? void 0 : params.link)
            window.open(params === null || params === void 0 ? void 0 : params.link, '_blank');
        else
...
/******/ })()
;
//# sourceMappingURL=https://sources.2sxc.org/16.00.01/inpage/inpage.min.js.map