...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 71870);
...
/* harmony import */ var _2sic_com_sxc_angular__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @2sic.com/sxc-angular */ 14821);
...
class DevRestBase extends _shared_components_base_component__WEBPACK_IMPORTED_MODULE_3__.BaseComponent {
  ...
  context, dialogRef, /** sxc-angular context. Used to resolve urls */
  dnnContext, router, route, permissionsService) {
    ...
    this.scenario$ = new rxjs__WEBPACK_IMPORTED_MODULE_6__.BehaviorSubject(___WEBPACK_IMPORTED_MODULE_0__.AllScenarios[0]);
  ...
  buildPermissionStream(routeTargetName) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.combineLatest)([(0,___WEBPACK_IMPORTED_MODULE_0__.fireOnStartAndWhenSubDialogCloses)(this.router, this.route), this.route.paramMap.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_8__.map)(pm => pm.get(routeTargetName)))]).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_9__.switchMap)(([_, permissionTarget]) => {
  ...
  static #_ = this.ɵfac = function DevRestBase_Factory(t) {
    return new (t || DevRestBase)(_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_app_administration_services__WEBPACK_IMPORTED_MODULE_1__.AppDialogConfigService), _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_shared_services_context__WEBPACK_IMPORTED_MODULE_5__.Context), _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_12__.MatDialogRef), _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_2sic_com_sxc_angular__WEBPACK_IMPORTED_MODULE_13__.Context), _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_14__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_14__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdirectiveInject"](_permissions__WEBPACK_IMPORTED_MODULE_2__.PermissionsService));
  };
...
const base = 'restapi';
class GoToDevRest {
  static #_ = this.routeQuery = 'restapiquery';
  static #_2 = this.routeData = 'restapidata';
  static #_3 = this.routeWebApi = 'restapiwebapi';
  static #_4 = this.navLabel = 'Rest-Api';
  static #_5 = this.icon = 'code-curly';
  static #_6 = this.routeDataDefinition = {
    name: GoToDevRest.navLabel,
    icon: GoToDevRest.icon,
    svgIcon: true,
    path: GoToDevRest.routeData
  };
  static #_7 = this.routeQueryDefinition = {
    name: GoToDevRest.navLabel,
    icon: GoToDevRest.icon,
    svgIcon: true,
    path: GoToDevRest.routeQuery
  };
  static #_8 = this.routeWebApiDefinition = {
    name: GoToDevRest.navLabel,
    icon: GoToDevRest.icon,
    svgIcon: true,
    path: GoToDevRest.routeWebApi
  };
  static #_9 = this.route = {
    path: base,
...
class HelpPopupComponent {
  ...
  static #_ = this.ɵfac = function HelpPopupComponent_Factory(t) {
    return new (t || HelpPopupComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__.MatDialogRef), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__.MAT_DIALOG_DATA));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
    ...
    template: function HelpPopupComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵconditional"](11, ctx.dialogData.notes ? 11 : -1);
      }
    },
...
/* harmony export */   fireOnStartAndWhenSubDialogCloses: () => (/* reexport safe */ _routing_helpers__WEBPACK_IMPORTED_MODULE_9__.fireOnStartAndWhenSubDialogCloses),
...
/* harmony import */ var _routing_helpers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./routing-helpers */ 25558);
...
/***/ 25558:
/*!*************************************************************!*\
  !*** ./projects/eav-ui/src/app/dev-rest/routing-helpers.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fireOnStartAndWhenSubDialogCloses: () => (/* binding */ fireOnStartAndWhenSubDialogCloses)
/* harmony export */ });
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ 95072);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ 51567);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ 5057);
...
function fireOnStartAndWhenSubDialogCloses(router, route) {
  return router.events.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_0__.filter)(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__.NavigationEnd), (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.startWith)(!!route.snapshot.firstChild), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.map)(() => !!route.snapshot.firstChild), (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.pairwise)(), (0,rxjs__WEBPACK_IMPORTED_MODULE_0__.filter)(([prevHadChild, newHasChild]) => prevHadChild && !newHasChild), (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.startWith)([]) // this ensures it fires once in the beginning
  );
}
...
class SelectorWithHelpComponent {
  ...
  static #_ = this.ɵfac = function SelectorWithHelpComponent_Factory(t) {
    return new (t || SelectorWithHelpComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__.MatDialog));
  };
