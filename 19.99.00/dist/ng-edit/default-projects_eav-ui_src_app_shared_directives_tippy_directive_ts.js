...
class TippyDirective {
  ...
  translate) {
    ...
    this.tippyData = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.input)();
    /**
  ...
  ngOnChanges(changes) {
    ...
    if (changes['tippy'] != null || changes['tippyTranslate'] != null || changes['tippyFontSize'] != null) {
      ...
      const contents = val ? this.translate?.instant(val, this.tippyData()) ?? val // temp with null-check in case the service is missing ATM
      : this.tippy()?.toString() ?? '';
