...
/* harmony import */ var _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/cdk/scrolling */ 79975);
/* harmony import */ var _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/cdk/overlay */ 81570);
...
/* harmony import */ var _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @angular/cdk/portal */ 9168);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! rxjs/operators */ 95074);
...
class MatAutocomplete {
  ...
  id = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_3__._IdGenerator).getId('mat-autocomplete-');
  /**
  ...
  ngAfterContentInit() {
    this._keyManager = new _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_3__.ActiveDescendantKeyManager(this.options).withWrap().skipPredicate(this._skipPredicate);
...
const MAT_AUTOCOMPLETE_SCROLL_STRATEGY = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('mat-autocomplete-scroll-strategy', {
  providedIn: 'root',
  factory: () => {
    const overlay = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_6__.Overlay);
...
class MatAutocompleteTrigger {
  ...
  _overlay = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_6__.Overlay);
  ...
  _formField = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__.MAT_FORM_FIELD, {
    optional: true,
    host: true
  });
  _viewportRuler = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_9__.ViewportRuler);
  ...
  _breakpointObserver = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_11__.BreakpointObserver);
  ...
  _closeKeyEventStream = new rxjs__WEBPACK_IMPORTED_MODULE_10__.Subject();
  /**
  ...
  closePanel() {
    ...
    if (this._trackedModal) {
      (0,_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_3__.removeAriaReferencedId)(this._trackedModal, 'aria-owns', this.autocomplete.id);
    }
  }
  /**
  ...
  get panelClosingActions() {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.merge)(this.optionSelections, this.autocomplete._keyManager.tabOut.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.filter)(() => this._overlayAttached)), this._closeKeyEventStream, this._getOutsideClickStream(), this._overlayRef ? this._overlayRef.detachments().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.filter)(() => this._overlayAttached)) : (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.of)()).pipe(
  ...
  optionSelections = (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.defer)(() => {
    const options = this.autocomplete ? this.autocomplete.options : null;
    if (options) {
      return options.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.startWith)(options), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.switchMap)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.merge)(...options.map(option => option.onSelectionChange))));
    }
    // If there are any subscribers before `ngAfterViewInit`, the `autocomplete` will be undefined.
    // Return a stream that we'll replace with the real one once everything is in place.
    return this._initialized.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.switchMap)(() => this.optionSelections));
  });
  ...
  _getOutsideClickStream() {
    return new rxjs__WEBPACK_IMPORTED_MODULE_19__.Observable(observer => {
      const listener = event => {
        ...
        const clickTarget = (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_4__._getEventTarget)(event);
  ...
  _hasFocus() {
    return (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_4__._getFocusedElementPierceShadowDom)() === this._element.nativeElement;
  }
  /**
  ...
  _subscribeToClosingActions() {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.merge)(initialRender, optionChanges).pipe(
    // create a new stream of panelClosingActions, replacing any previous streams
    // that were created, and flatten it so our stream only emits closing events...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.switchMap)(() => this._zone.run(() => {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_23__.take)(1))
  ...
  _openPanelInternal(valueOnAttach = this._element.nativeElement.value) {
    ...
    if (this._trackedModal) {
      ...
      (0,_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_3__.addAriaReferencedId)(this._trackedModal, 'aria-owns', panelId);
    }
  }
  _attachOverlay(valueOnAttach) {
    ...
    if (!overlayRef) {
      ...
      // handsetLandscape.
      this._handsetLandscapeSubscription = this._breakpointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_11__.Breakpoints.HandsetLandscape).subscribe(result => {
...
class MatAutocompleteModule {
  ...
  static ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
    ...
    imports: [_angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_6__.OverlayModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatOptionModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatCommonModule, _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_9__.CdkScrollableModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatOptionModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatCommonModule]
  });
}
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MatAutocompleteModule, [{
    ...
    args: [{
      imports: [_angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_6__.OverlayModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatOptionModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatCommonModule, MatAutocomplete, MatAutocompleteTrigger, MatAutocompleteOrigin],
      exports: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_9__.CdkScrollableModule, MatAutocomplete, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatOptionModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatCommonModule, MatAutocompleteTrigger, MatAutocompleteOrigin],
      providers: [MAT_AUTOCOMPLETE_SCROLL_STRATEGY_FACTORY_PROVIDER]
    }]
  }], null, null);
})();
