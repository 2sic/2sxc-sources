...
const manageContentRoutes = [{
  ...
  children: [..._edit_edit_routing__WEBPACK_IMPORTED_MODULE_2__.EditRoutes, {
    ...
    loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ../replace-content/replace-content.routing */ 97440)).then(m => m.replaceContentRoutes)
  }]
}];
...
const manageContentListDialog = {
  ...
  getComponent() {
    return (0,C_Projects_2sxc_eav_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      } = yield Promise.all(/*! import() */[__webpack_require__.e("default-projects_eav-ui_src_app_shared_directives_tippy_directive_ts"), __webpack_require__.e("default-projects_eav-ui_src_app_shared_directives_mousedown-stop-propagation_directive_ts-pro-96cd25"), __webpack_require__.e("common"), __webpack_require__.e("projects_eav-ui_src_app_manage-content-list_manage-content-list_component_ts-projects_eav-ui_-8d5b99")]).then(__webpack_require__.bind(__webpack_require__, /*! ./manage-content-list.component */ 52645));
