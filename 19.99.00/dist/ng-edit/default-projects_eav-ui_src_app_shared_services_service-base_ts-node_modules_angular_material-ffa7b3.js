"use strict";
(self["webpackChunkeav_ui"] = self["webpackChunkeav_ui"] || []).push([["default-projects_eav-ui_src_app_shared_services_service-base_ts-node_modules_angular_material-ffa7b3"],{
...
/* harmony import */ var _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/cdk/overlay */ 81570);
...
class MatMenuItem {
  ...
  constructor() {
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_4__._CdkPrivateStyleLoader).load(_angular_material_core__WEBPACK_IMPORTED_MODULE_5__._StructuralStylesLoader);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MatMenuItem, [{
    ...
    args: [{
      ...
      imports: [_angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatRipple],
...
class MatMenuContent {
  ...
  attach(context = {}) {
    ...
    this.detach();
    if (!this._outlet) {
      this._outlet = new _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_6__.DomPortalOutlet(this._document.createElement('div'), null, this._appRef, this._injector);
    }
...
class MatMenu {
   ...
   */
  close = this.closed;
  panelId = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_2__._IdGenerator).getId('mat-menu-panel-');
  constructor() {
  ...
  ngAfterContentInit() {
    ...
    this._keyManager = new _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_2__.FocusKeyManager(this._directDescendantItems).withWrap().withTypeAhead().withHomeAndEnd();
...
class MatMenuTrigger {
  _overlay = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_11__.Overlay);
  ...
  _dir = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_12__.Directionality, {
    optional: true
  });
  _focusMonitor = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_2__.FocusMonitor);
  ...
  _overlayRef = null;
  _menuOpen = false;
  _closingActionsSubscription = rxjs__WEBPACK_IMPORTED_MODULE_13__.Subscription.EMPTY;
  _hoverSubscription = rxjs__WEBPACK_IMPORTED_MODULE_13__.Subscription.EMPTY;
  _menuCloseSubscription = rxjs__WEBPACK_IMPORTED_MODULE_13__.Subscription.EMPTY;
  _pendingRemoval;
  /**
  ...
  constructor() {
    ...
    this._cleanupTouchstart = (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_14__._bindEventWithOptions)(renderer, this._element.nativeElement, 'touchstart', event => {
      if (!(0,_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_2__.isFakeTouchstartFromScreenReader)(event)) {
  ...
  _destroyMenu(reason) {
    ...
    if (menu instanceof MatMenu && this._ownsMenu(menu)) {
      this._pendingRemoval = menu._animationDone.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.take)(1)).subscribe(() => {
        overlayRef.detach();
  ...
  _menuClosingActions() {
    ...
    const hover = this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.filter)(active => this._menuOpen && active !== this._menuItemInstance)) : (0,rxjs__WEBPACK_IMPORTED_MODULE_17__.of)();
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.merge)(backdrop, parentClose, hover, detachments);
  }
  /** Handles mouse presses on the trigger. */
  _handleMousedown(event) {
    if (!(0,_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_2__.isFakeMousedownFromScreenReader)(event)) {
...
class MatMenuModule {
  ...
  static ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
    ...
    imports: [_angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatRippleModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatCommonModule, _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_11__.OverlayModule, _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_19__.CdkScrollableModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatCommonModule]
  });
}
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MatMenuModule, [{
    ...
    args: [{
      imports: [_angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatRippleModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatCommonModule, _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_11__.OverlayModule, MatMenu, MatMenuItem, MatMenuContent, MatMenuTrigger],
      exports: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_19__.CdkScrollableModule, MatMenu, _angular_material_core__WEBPACK_IMPORTED_MODULE_5__.MatCommonModule, MatMenuItem, MatMenuContent, MatMenuTrigger],
      providers: [MAT_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER]
    }]
  }], null, null);
})();
...
//# sourceMappingURL=default-projects_eav-ui_src_app_shared_services_service-base_ts-node_modules_angular_material-ffa7b3.js.map