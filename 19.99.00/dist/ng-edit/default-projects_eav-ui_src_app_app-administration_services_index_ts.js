...
class PipelinesService extends _shared_services_http_service_base__WEBPACK_IMPORTED_MODULE_3__.HttpServiceBase {
  constructor() {
    super(...arguments);
  ...
  getAll(contentType) {
    ...
    return l.r(this.getHttpApiUrl(_shared_services_entity_service__WEBPACK_IMPORTED_MODULE_2__.webApiEntityList, {
      params: {
        appId: this.appId,
        contentType
      }
  ...
  getAllSig(contentType, initial) {
    ...
    const sig = this.getSignal(_shared_services_entity_service__WEBPACK_IMPORTED_MODULE_2__.webApiEntityList, {
      params: {
        appId: this.appId,
        contentType
      }
  ...
  getAllRes(contentType, initial) {
    const l = this.log.fnIf('getAllRes');
    const res = (0,_angular_common_http__WEBPACK_IMPORTED_MODULE_4__.httpResource)(() => ({
      url: _shared_services_entity_service__WEBPACK_IMPORTED_MODULE_2__.webApiEntityList,
      params: {
        appId: this.appId,
        contentType
      }
  ...
  importQuery(file) {
    ...
    const obs = (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.from)((0,_shared_helpers_file_to_base64_helper__WEBPACK_IMPORTED_MODULE_0__.toBase64)(file)).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.switchMap)(fileBase64 => {
  ...
  clonePipeline(id) {
    ...
    const obs = this.getHttpApiUrl(webApiQueryClone, {
      params: {
        Id: id.toString(),
        appId: this.appId
      }
  ...
  delete(id) {
    ...
    const obs = this.http.delete(this.apiUrl(webApiQueryDelete), {
      params: {
        appId: this.appId,
        Id: id.toString()
      }
  ...
  static {
    this.ɵfac = /*@__PURE__*/(() => {
      ...
      return function PipelinesService_Factory(__ngFactoryType__) {
        return (ɵPipelinesService_BaseFactory || (ɵPipelinesService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵgetInheritedFactory"](PipelinesService)))(__ngFactoryType__ || PipelinesService);
      };
    })();
  }
  static {
