...
/* harmony import */ var _angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/cdk/bidi */ 63680);
...
/* harmony import */ var _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/cdk/scrolling */ 79975);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs/operators */ 87378);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! rxjs/operators */ 52575);
...
class MatDrawerContent extends _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollable {
  ...
  _container = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MatDrawerContainer);
  constructor() {
    ...
    const scrollDispatcher = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.ScrollDispatcher);
  ...
  static ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    hostBindings: function MatDrawerContent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("mat-drawer-content-hidden", ctx._shouldBeHidden());
      }
    },
    features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([{
      provide: _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollable,
...
class MatDrawer {
  ...
  _focusTrapFactory = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_3__.FocusTrapFactory);
  ...
  _interactivityChecker = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_3__.InteractivityChecker);
  _doc = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_4__.DOCUMENT, {
    optional: true
  });
  _container = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MAT_DRAWER_CONTAINER, {
    optional: true
  });
  _focusTrap = null;
  ...
  set disableClose(value) {
    this._disableClose = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceBooleanProperty)(value);
  }
  _disableClose = false;
  /**
  ...
  set autoFocus(value) {
    if (value === 'true' || value === 'false' || value == null) {
      value = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceBooleanProperty)(value);
    }
  ...
  set opened(value) {
    this.toggle((0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceBooleanProperty)(value));
  }
  _opened = false;
  /** How the sidenav was opened (keypress, mouse click etc.) */
  _openedVia;
  /** Emits whenever the drawer has started animating. */
  _animationStarted = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  /** Emits whenever the drawer is done animating. */
  _animationEnd = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  /** Event emitted when the drawer open state is changed. */
  openedChange =
  // Note this has to be async in order to avoid some issues with two-bindings (see #8872).
  new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter(/* isAsync */true);
  /** Event emitted when the drawer has been opened. */
  _openedStream = this.openedChange.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(o => o), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)(() => {}));
  /** Event emitted when the drawer has started opening. */
  openedStart = this._animationStarted.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(() => this.opened), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.mapTo)(undefined));
  /** Event emitted when the drawer has been closed. */
  _closedStream = this.openedChange.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(o => !o), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)(() => {}));
  /** Event emitted when the drawer has started closing. */
  closedStart = this._animationStarted.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(() => !this.opened), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.mapTo)(undefined));
  /** Emits when the component is destroyed. */
  _destroyed = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  /** Event emitted when the drawer's position changes. */
  // tslint:disable-next-line:no-output-on-prefix
  onPositionChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
   ...
   */
  _modeChanged = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  _injector = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_0__.Injector);
  _changeDetectorRef = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef);
  constructor() {
    this.openedChange.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.takeUntil)(this._destroyed)).subscribe(opened => {
      if (opened) {
        if (this._doc) {
    ...
    this._ngZone.runOutsideAngular(() => {
      ...
      (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.fromEvent)(element, 'keydown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(event => {
        return event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_12__.ESCAPE && !this.disableClose && !(0,_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_12__.hasModifierKey)(event);
  ...
  _setOpen(isOpen, restoreFocus, focusOrigin) {
    ...
    return new Promise(resolve => {
      this.openedChange.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.take)(1)).subscribe(open => resolve(open ? 'open' : 'close'));
    });
  }
  ...
  static ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    hostBindings: function MatDrawer_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstyleProp"]("visibility", !ctx._container && !ctx.opened ? "hidden" : null);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("mat-drawer-end", ctx.position === "end")("mat-drawer-over", ctx.mode === "over")("mat-drawer-push", ctx.mode === "push")("mat-drawer-side", ctx.mode === "side");
      }
    },
    inputs: {
      position: "position",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MatDrawer, [{
    ...
    args: [{
      ...
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectionStrategy.OnPush,
      encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__.ViewEncapsulation.None,
      imports: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollable],
...
class MatDrawerContainer {
  _dir = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_14__.Directionality, {
    optional: true
  });
  ...
  _drawers = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.QueryList();
  _content;
  _userContent;
  ...
  set autosize(value) {
    this._autosize = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceBooleanProperty)(value);
  }
  _autosize = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(MAT_DRAWER_DEFAULT_AUTOSIZE);
  /**
  ...
  set hasBackdrop(value) {
    this._backdropOverride = value == null ? null : (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceBooleanProperty)(value);
  }
  _backdropOverride;
  ...
  _doCheckSubject = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  /**
  ...
  _contentMarginChanges = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  ...
  constructor() {
    ...
    const viewportRuler = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.ViewportRuler);
  ...
  ngAfterContentInit() {
    this._allDrawers.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.startWith)(this._allDrawers), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.takeUntil)(this._destroyed)).subscribe(drawer => {
  ...
  _watchDrawerToggle(drawer) {
    drawer._animationStarted.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.takeUntil)(this._drawers.changes)).subscribe(() => {
      this.updateContentMargins();
      this._changeDetectorRef.markForCheck();
    });
    if (drawer.mode !== 'side') {
  ...
  _watchDrawerMode(drawer) {
    drawer._modeChanged.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.takeUntil)((0,rxjs__WEBPACK_IMPORTED_MODULE_17__.merge)(this._drawers.changes, this._destroyed))).subscribe(() => {
      this.updateContentMargins();
      this._changeDetectorRef.markForCheck();
    });
  }
...
class MatSidenavContent extends MatDrawerContent {
  static ɵfac = /* @__PURE__ */(() => {
    ...
    return function MatSidenavContent_Factory(__ngFactoryType__) {
      return (ɵMatSidenavContent_BaseFactory || (ɵMatSidenavContent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](MatSidenavContent)))(__ngFactoryType__ || MatSidenavContent);
    };
  })();
  static ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
...
class MatSidenav extends MatDrawer {
  ...
  set fixedInViewport(value) {
    this._fixedInViewport = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceBooleanProperty)(value);
  }
  ...
  set fixedTopGap(value) {
    this._fixedTopGap = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceNumberProperty)(value);
  }
  _fixedTopGap = 0;
  /**
  ...
  set fixedBottomGap(value) {
    this._fixedBottomGap = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_5__.coerceNumberProperty)(value);
  }
  _fixedBottomGap = 0;
  static ɵfac = /* @__PURE__ */(() => {
  ...
  static ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    hostBindings: function MatSidenav_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("mat-drawer-end", ctx.position === "end")("mat-drawer-over", ctx.mode === "over")("mat-drawer-push", ctx.mode === "push")("mat-drawer-side", ctx.mode === "side")("mat-sidenav-fixed", ctx.fixedInViewport);
      }
    },
    inputs: {
...
class MatSidenavModule {
  ...
  static ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
    imports: [_angular_material_core__WEBPACK_IMPORTED_MODULE_18__.MatCommonModule, _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollableModule, _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollableModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_18__.MatCommonModule]
  });
}
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MatSidenavModule, [{
    ...
    args: [{
      imports: [_angular_material_core__WEBPACK_IMPORTED_MODULE_18__.MatCommonModule, _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollableModule, MatDrawer, MatDrawerContainer, MatDrawerContent, MatSidenav, MatSidenavContainer, MatSidenavContent],
      exports: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_1__.CdkScrollableModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_18__.MatCommonModule, MatDrawer, MatDrawerContainer, MatDrawerContent, MatSidenav, MatSidenavContainer, MatSidenavContent]
    }]
  }], null, null);
})();
...
class NavItemListComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      styles: [".paddingLink[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  padding-left: 40px;\n}\n\n.active[_ngcontent-%COMP%] {\n  background-color: rgba(128, 128, 128, 0.1);\n}\n\n.app-menu-container[_ngcontent-%COMP%] {\n  padding: 15px 25px;\n  display: flex;\n  align-items: center;\n  text-decoration: none;\n  color: black;\n  transition: all 225ms ease-in-out;\n}\n.app-menu-container[_ngcontent-%COMP%]:hover {\n  background-color: rgba(128, 128, 128, 0.2);\n}\n.app-menu-container[_ngcontent-%COMP%]   .link-text[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: 500;\n  margin-left: 25px;\n}\n.app-menu-container[_ngcontent-%COMP%]   .mat-icon[_ngcontent-%COMP%] {\n  transition: all 225ms ease-in-out;\n}\n.app-menu-container[_ngcontent-%COMP%]   .mat-icon.ml-auto[_ngcontent-%COMP%] {\n  margin-left: auto;\n}\n.app-menu-container[_ngcontent-%COMP%]   .open[_ngcontent-%COMP%] {\n  transform: rotate(180deg);\n}\n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
