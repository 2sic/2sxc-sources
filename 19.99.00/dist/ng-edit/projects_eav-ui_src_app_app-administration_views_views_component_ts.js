...
/* harmony import */ var _shared_routing_dialog_in_new_window_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../shared/routing/dialog-in-new-window.service */ 71693);
/* harmony import */ var _shared_routing_dialog_routing_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../shared/routing/dialog-routing.service */ 60852);
...
class ViewsComponent {
  ...
  matDialog, viewContainerRef, changeDetectorRef) {
    ...
    this.#dialogInNewWindowSvc = (0,_core__WEBPACK_IMPORTED_MODULE_1__.transient)(_shared_routing_dialog_in_new_window_service__WEBPACK_IMPORTED_MODULE_15__.DialogInNewWindowService);
    ...
    this.#dialogRouter = (0,_core__WEBPACK_IMPORTED_MODULE_1__.transient)(_shared_routing_dialog_routing_service__WEBPACK_IMPORTED_MODULE_16__.DialogRoutingService);
    this.polymorphLogo = _url_loader_polymorph_logo_png__WEBPACK_IMPORTED_MODULE_0__["default"];
    this.gridOptions = this.#buildGridOptions();
    this.#refresh = (0,_angular_core__WEBPACK_IMPORTED_MODULE_23__.signal)(1); // must start with 1 so it can be chained in computed as ...refresh() && ...
    this.views = (0,_angular_core__WEBPACK_IMPORTED_MODULE_23__.computed)(() => this.#refresh() && this.#viewsSvc.getAll());
    this.#polymorphismLazy = (0,_angular_core__WEBPACK_IMPORTED_MODULE_23__.computed)(() => this.#refresh() && this.#viewsSvc.getPolymorphism());
    this.polymorphStatus = (0,_angular_core__WEBPACK_IMPORTED_MODULE_23__.computed)(() => {
      ...
      ? 'not configured' : polymorphism.Resolver === null ? 'disabled' : 'using ' + polymorphism.Resolver;
    });
  }
  #refresh; // must start with 1 so it can be chained in computed as ...refresh() && ...
  #polymorphismLazy;
  ngOnInit() {
  ...
  #buildGridOptions() {
    ...
    const gridOptions = {
      ...
      columnDefs: [{
        ...
        cellClass: p => `id-action no-padding no-outline ${p.data.EditInfo.ReadOnly ? 'disabled' : ''}`.split(' '),
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_23__["ɵɵdefineComponent"]({
      ...
      dependencies: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_25__.MatDialogActions, _angular_material_button__WEBPACK_IMPORTED_MODULE_26__.MatButtonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_26__.MatButton, _angular_material_button__WEBPACK_IMPORTED_MODULE_26__.MatFabButton, _angular_material_icon__WEBPACK_IMPORTED_MODULE_27__.MatIconModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_27__.MatIcon, _angular_router__WEBPACK_IMPORTED_MODULE_28__.RouterOutlet, _shared_modules_sxc_grid_module_sxc_grid_module__WEBPACK_IMPORTED_MODULE_14__.SxcGridModule, _ag_grid_community_angular__WEBPACK_IMPORTED_MODULE_29__.AgGridAngular, _shared_directives_drag_and_drop_directive__WEBPACK_IMPORTED_MODULE_10__.DragAndDropDirective, _shared_directives_tippy_directive__WEBPACK_IMPORTED_MODULE_11__.TippyDirective],
      styles: [".eav-polymorph-button[_ngcontent-%COMP%]   .eav-polymorph-button-span[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n\n.eav-polymorph-logo[_ngcontent-%COMP%] {\n  width: 24px;\n  height: 24px;\n  margin-right: 4px;\n}\n\n.eav-polymorph-button[disabled][_ngcontent-%COMP%]   .eav-polymorph-logo[_ngcontent-%COMP%] {\n  opacity: 33%;\n  filter: grayscale(1);\n}\n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
