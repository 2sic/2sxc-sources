...
/* harmony import */ var _app_app_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app/app.component */ 41397);
/* harmony import */ var _app_app_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app/app.config */ 34306);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./environments/environment */ 66619);





if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.production) (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.enableProdMode)();
...
/***/ 9001:
/*!**************************************************************!*\
  !*** ./projects/eav-ui/src/app/features/features.service.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _features_disable_autoload_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./features-disable-autoload.service */ 34156);
...
class FeaturesService {
  ...
  constructor(disableAutoLoad) {
    ...
    this.#dialogContext = (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.signal)(null);
    ...
    if (!disableAutoLoad.disableAutoLoad) this.#dialogConfigSvc.getCurrent$().subscribe(ds => this.load(ds.Context));else this.log.a('auto-load disabled');
  }
  ...
  static {
    this.ɵfac = function FeaturesService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || FeaturesService)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_features_disable_autoload_service__WEBPACK_IMPORTED_MODULE_5__.FeaturesDisableAutoLoadService));
    };
  }
  static {
...
// NEW
{
  ...
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_angular_material_fesm2022_dialog_mjs"), __webpack_require__.e("common"), __webpack_require__.e("projects_eav-ui_src_app_item-history_item-history_routing_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./item-history/item-history.routing */ 65022)).then(m => m.historyRoutes)
...
/***/ 34156:
/*!*******************************************************************************!*\
  !*** ./projects/eav-ui/src/app/features/features-disable-autoload.service.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FeaturesDisableAutoLoadService: () => (/* binding */ FeaturesDisableAutoLoadService)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 37580);
 ...
 * Experimental
 */
class FeaturesDisableAutoLoadService {
  constructor() {
    this.disableAutoLoad = false;
  }
  static {
    this.ɵfac = function FeaturesDisableAutoLoadService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || FeaturesDisableAutoLoadService)();
    };
  }
  static {
    this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: FeaturesDisableAutoLoadService,
      factory: FeaturesDisableAutoLoadService.ɵfac,
      providedIn: 'root'
    });
  }
}
...
/* harmony export */ });
/* harmony import */ var _2sic_com_sxc_angular__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @2sic.com/sxc-angular */ 81955);
...
/* harmony import */ var _shared_interceptors_handle_errors_interceptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/interceptors/handle-errors.interceptor */ 85837);
/* harmony import */ var _shared_interceptors_set_headers_interceptor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/interceptors/set-headers.interceptor */ 41248);
/* harmony import */ var _shared_routing_app_entry_route_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/routing/app-entry-route-handler */ 92363);
...
const appConfig = {
  ...
  (0,_angular_common_http__WEBPACK_IMPORTED_MODULE_14__.provideHttpClient)((0,_angular_common_http__WEBPACK_IMPORTED_MODULE_14__.withInterceptorsFromDi)()), {
    ...
    useClass: _shared_interceptors_set_headers_interceptor__WEBPACK_IMPORTED_MODULE_3__.SetHeadersInterceptor,
    multi: true
  }, {
    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_14__.HTTP_INTERCEPTORS,
    useClass: _shared_interceptors_handle_errors_interceptor__WEBPACK_IMPORTED_MODULE_2__.HandleErrorsInterceptor,
    multi: true
  }, {
...
/***/ 41235:
/*!*********************************************************************!*\
  !*** ./projects/eav-ui/src/app/shared/routing/route-link-helper.ts ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RouteLinkHelper: () => (/* binding */ RouteLinkHelper)
/* harmony export */ });
class RouteLinkHelper {
  routeTo(context, path) {
...
const log = (0,_logging__WEBPACK_IMPORTED_MODULE_1__.classLog)("UrlPrepHelper");
...
function convertUrlToForm(formUrl) {
  ...
  for (const item of items) {
    ...
    if (item.startsWith(GROUP_PREFIX)) {
      ...
      const editItem = _models_edit_form_model__WEBPACK_IMPORTED_MODULE_2__.EditPrep.editId(parseInt(parts[0], 10));
...
/* harmony import */ var _features_features_disable_autoload_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../features/features-disable-autoload.service */ 34156);
...
const editDialog = {
  ...
  getComponent(injector) {
    return (0,C_Projects_2sxc_eav_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      injector.get(_features_features_disable_autoload_service__WEBPACK_IMPORTED_MODULE_1__.FeaturesDisableAutoLoadService).disableAutoLoad = true;
      const {
        EditEntryComponent
      } = yield Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_angular_forms_fesm2022_forms_mjs"), __webpack_require__.e("default-projects_eav-ui_src_app_shared_directives_tippy_directive_ts"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_input_mjs"), __webpack_require__.e("default-projects_eav-ui_src_app_shared_components_base_component_ts-projects_eav-ui_src_app_s-83efe3"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_radio_mjs"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_dialog_mjs"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_badge_mjs"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_select_mjs"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_card_mjs"), __webpack_require__.e("default-projects_eav-ui_src_app_features_shared_base-feature_component_ts"), __webpack_require__.e("default-projects_eav-ui_src_app_shared_services_service-base_ts-node_modules_angular_material-ffa7b3"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_slide-toggle_mjs"), __webpack_require__.e("default-projects_eav-ui_src_app_edit_form_form-config_service_ts-projects_eav-ui_src_app_edit-b26668"), __webpack_require__.e("default-projects_eav-ui_src_app_features_feature-icon_feature-icon_component_ts-projects_eav--06ee1b"), __webpack_require__.e("default-projects_eav-ui_src_app_create-file-dialog_create-file-dialog_component_ts"), __webpack_require__.e("default-projects_eav-ui_src_app_shared_directives_mousedown-stop-propagation_directive_ts-pro-96cd25"), __webpack_require__.e("default-node_modules_angular_material_fesm2022_autocomplete_mjs"), __webpack_require__.e("default-projects_eav-ui_src_app_edit_dialog_main_keyboard-shortcuts_ts-projects_eav-ui_src_ap-9ff1ab"), __webpack_require__.e("default-projects_eav-ui_src_app_features_feature-icon-text_feature-icon-text_component_ts-pro-6e06e2"), __webpack_require__.e("common"), __webpack_require__.e("projects_eav-ui_src_app_edit_dialog_entry_edit-entry_component_ts-projects_eav-ui_src_app_sha-ddd80a")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dialog/entry/edit-entry.component */ 68032));
...
/***/ 92363:
/*!***************************************************************************!*\
  !*** ./projects/eav-ui/src/app/shared/routing/app-entry-route-handler.ts ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AppEntryRouteHandler: () => (/* binding */ AppEntryRouteHandler)
/* harmony export */ });
...
/* harmony import */ var _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constants/dialog-type.constants */ 37567);
/* harmony import */ var _constants_session_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../constants/session.constants */ 38172);
/* harmony import */ var _helpers_url_prep_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/url-prep.helper */ 43216);
/* harmony import */ var _logging__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../logging */ 34435);
/* harmony import */ var _route_link_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./route-link-helper */ 41235);
 ...
 */
class AppEntryRouteHandler {
  /**
   * Constructor, will call initializer
   */
  constructor(injector) {
    this.injector = injector;
    this.log = (0,_logging__WEBPACK_IMPORTED_MODULE_4__.classLog)({
      AppEntryRouteHandler
    }, {
      all: true,
      constructor: false,
  ...
  #processEntryUrl() {
    ...
    const eavKeys = Object.keys(sessionStorage).filter(key => key.startsWith(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.prefix));
    if (eavKeys.length === 0) {
      this.#logInitialRoute();
    ...
    this.#logInitialRoute(sessionStorage.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyUrl));
    l.end();
  }
  /**
  ...
  handleLongEntryRouteWithState() {
    ...
    const eavKeys = Object.keys(sS).filter(key => key.startsWith(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.prefix));
    ...
    sS.setItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyUrl, window.location.href);
    sS.setItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyDialog, _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Edit);
    ...
    const dialog = sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyDialog);
    const contentType = sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyContentType);
    const items = sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyItems);
    ...
    const getFull = () => new _route_link_helper__WEBPACK_IMPORTED_MODULE_5__.RouteLinkHelper().routeRoot({
      zoneId: sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyZoneId),
      moduleId: sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyModuleId),
      contentBlockId: sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyContentBlockId),
      appId: sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyAppId)
    });
    l.a('dialog: ' + dialog);
    function go(route, extras) {
      router.navigate([`${getFull()}${route}`], extras);
      l.end(dialog);
    }
    switch (dialog) {
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Zone:
        const extrasZone = JSON.parse(sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyExtras));
        return go(`/apps${extrasZone?.tab ? `/${extrasZone.tab}` : ''}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Apps:
        return go(`/apps/list`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.AppImport:
        return go(`/import`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.App:
        const extrasApp = JSON.parse(sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyExtras));
        return go(`/app${extrasApp?.tab ? `/${extrasApp.tab}` : ''}${extrasApp?.scope ? `/${extrasApp.scope}` : ''}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.ContentType:
        return go(`/fields/${contentType}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.ContentItems:
        return go(`/items/${contentType}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Edit:
        const editItems = JSON.parse(items);
        const formUrl = (0,_helpers_url_prep_helper__WEBPACK_IMPORTED_MODULE_3__.convertFormToUrl)({
          items: editItems
        });
        return go(`/edit/${formUrl}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.ItemHistory:
        const historyItems = JSON.parse(items);
        return go(`/versions/${historyItems[0].EntityId}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Develop:
        return go(`/code`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.PipelineDesigner:
        const pipelineId = sS.getItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.keyPipelineId);
        return go(`/query/${pipelineId}`);
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.Replace:
        const repItem = JSON.parse(items)[0];
        const queryParams = repItem.Add ? {
          add: true
        } : {};
        return go(`/${repItem.Parent}/${repItem.Field}/${repItem.Index}/replace`, {
          queryParams
        });
      case _constants_dialog_type_constants__WEBPACK_IMPORTED_MODULE_1__.DialogTypeConstants.InstanceList:
  ...
  #handleNonNormalEntryParamRoute() {
    ...
    if (!isNaN(+mid) && !isNaN(+cbid) && !isNaN(+appId)) {
      ...
      this.#transferToSession(_edit_shared_helpers_url_helpers__WEBPACK_IMPORTED_MODULE_0__.UrlHelpers.urlParamsToDic(ctxAll));
      const router = this.injector.get(_angular_router__WEBPACK_IMPORTED_MODULE_6__.Router);
  ...
  #transferToSession(queryParametersFromUrl) {
    const l = this.log.fnIf('transferToSession', {
      queryParametersFromUrl
    });
    for (const [paramKey, paramValue] of Object.entries(queryParametersFromUrl)) if (paramValue != null) sessionStorage.setItem(_constants_session_constants__WEBPACK_IMPORTED_MODULE_2__.prefix + paramKey, paramValue);
    l.end();
  }
}
...
class HttpServiceBase {
  ...
  getHttpApiUrl(endpoint, options) {
    ...
    return this.http.get(url, options ?? undefined); // has a quick, null would fail, undefined is ok
  }
   ...
   * @returns
   */
  getSignal(endpoint, options, initial, reMap) {
    ...
    this.getHttpApiUrl(endpoint, options).subscribe(d => {
      ...
      const transformed = reMap ? reMap(d) : d;
