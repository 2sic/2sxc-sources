...
/* harmony import */ var _shared_logging__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../shared/logging */ 34435);
...
/* harmony import */ var _shared_routing_dialog_routing_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../shared/routing/dialog-routing.service */ 60852);
/* harmony import */ var _shared_routing_route_link_helper__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../shared/routing/route-link-helper */ 41235);
...
/* harmony import */ var _services_pipelines_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../services/pipelines.service */ 74079);
/* harmony import */ var _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./queries-actions/queries-actions */ 78060);
/* harmony import */ var _queries_actions_queries_actions_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./queries-actions/queries-actions.component */ 79693);
...
class QueriesComponent {
  ...
  #snackBar;
  constructor() {
    this.log = (0,_shared_logging__WEBPACK_IMPORTED_MODULE_11__.classLog)({
      QueriesComponent
    }, logSpecs);
    this.#pipelineSvc = (0,_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_services_pipelines_service__WEBPACK_IMPORTED_MODULE_18__.PipelinesService);
    ...
    this.#dialogRouter = (0,_core__WEBPACK_IMPORTED_MODULE_0__.transient)(_shared_routing_dialog_routing_service__WEBPACK_IMPORTED_MODULE_14__.DialogRoutingService);
    ...
    this.#context = (0,_angular_core__WEBPACK_IMPORTED_MODULE_21__.inject)(_shared_services_context__WEBPACK_IMPORTED_MODULE_16__.Context);
    this.#snackBar = (0,_angular_core__WEBPACK_IMPORTED_MODULE_21__.inject)(_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_22__.MatSnackBar);
    this.gridOptions = this.buildGridOptions();
    this.#refresh = (0,_angular_core__WEBPACK_IMPORTED_MODULE_21__.signal)(0);
    this.queries = (0,_angular_core__WEBPACK_IMPORTED_MODULE_21__.computed)(() => {
  ...
  #urlToEditOrNew(query) {
    return this.#urlTo(`edit/${(0,_shared_helpers_url_prep_helper__WEBPACK_IMPORTED_MODULE_10__.convertFormToUrl)({
      items: [query == null ? _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_12__.EditPrep.newFromType(_shared_constants_eav_constants__WEBPACK_IMPORTED_MODULE_7__.eavConstants.contentTypes.query, {
        TestParameters: _shared_constants_eav_constants__WEBPACK_IMPORTED_MODULE_7__.eavConstants.pipelineDesigner.testParameters
      }) : _shared_models_edit_form_model__WEBPACK_IMPORTED_MODULE_12__.EditPrep.editId(query.Id)]
    })}`);
  }
  #urlToOpenVisualQueryDesigner(query) {
    return '#/' + new _shared_routing_route_link_helper__WEBPACK_IMPORTED_MODULE_15__.RouteLinkHelper().routeTo(this.#context, `query/${query.Id}`);
  }
  ...
  cloneQuery(query) {
    const l = this.log.fnIf('cloneQuery', {
      query
    });
  ...
  exportQuery(query) {
    const l = this.log.fnIf('exportQuery', {
      query
    });
  ...
  deleteQuery(query) {
    const l = this.log.fnIf('deleteQuery', {
      query
    });
  ...
  #titleCellRenderer(query) {
    const l = this.log.fnIf('titleCellRenderer', {
      query
    });
  ...
  buildGridOptions() {
    const gridOptions = {
      ...
      columnDefs: [{
        ...
        field: 'Name',
        sort: 'asc',
        cellClass: p => `${p.data._EditInfo.DisableEdit ? 'no-outline' : 'primary-action highlight'}`.split(' '),
        cellRenderer: p => this.#titleCellRenderer(p.data)
      }, {
        ...
        cellRenderer: _queries_actions_queries_actions_component__WEBPACK_IMPORTED_MODULE_20__.QueriesActionsComponent,
        cellRendererParams: {
          getEnablePermissions: () => this.enablePermissions,
          do: (action, query) => {
            switch (action) {
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Clone:
                return this.cloneQuery(query);
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Export:
                return this.exportQuery(query);
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Delete:
                return this.deleteQuery(query);
            }
          },
          urlTo: (action, query) => {
            switch (action) {
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Edit:
                return this.#urlToEditOrNew(query);
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Metadata:
                return this.#urlToOpenMetadata(query);
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Rest:
                return this.#urlToRestApi(query);
              case _queries_actions_queries_actions__WEBPACK_IMPORTED_MODULE_19__.QueryActions.Permissions:
                return this.#urlToPermissions(query);
            }
          }
        }
      }]
  ...
  static {
    this.ɵfac = function QueriesComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || QueriesComponent)();
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵdefineComponent"]({
      ...
      template: function QueriesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵlistener"]("filesDropped", function QueriesComponent_Template_ag_grid_angular_filesDropped_1_listener($event) {
            return ctx.importQuery($event);
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementStart"](2, "mat-dialog-actions", 2)(3, "a", 3)(4, "mat-icon", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵtext"](5, "cloud_upload");
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementStart"](6, "span");
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵtext"](7, "Query");
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementStart"](8, "a", 5)(9, "mat-icon");
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵtext"](10, "add");
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelementEnd"]()()()();
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵelement"](11, "router-outlet");
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵadvance"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵproperty"]("rowData", ctx.queries()())("gridOptions", ctx.gridOptions)("allowedFileTypes", "json");
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵadvance"](2);
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵproperty"]("href", ctx.urlToImportQuery(), _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵsanitizeUrl"]);
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵproperty"]("href", ctx.urlToNewQuery(), _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵsanitizeUrl"]);
        }
      },
      dependencies: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_23__.MatDialogActions, _angular_material_button__WEBPACK_IMPORTED_MODULE_24__.MatButtonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_24__.MatAnchor, _angular_material_button__WEBPACK_IMPORTED_MODULE_24__.MatFabAnchor, _angular_material_icon__WEBPACK_IMPORTED_MODULE_25__.MatIconModule, _angular_material_icon__WEBPACK_IMPORTED_MODULE_25__.MatIcon, _angular_router__WEBPACK_IMPORTED_MODULE_26__.RouterOutlet, _shared_modules_sxc_grid_module_sxc_grid_module__WEBPACK_IMPORTED_MODULE_13__.SxcGridModule, _ag_grid_community_angular__WEBPACK_IMPORTED_MODULE_27__.AgGridAngular, _shared_directives_drag_and_drop_directive__WEBPACK_IMPORTED_MODULE_8__.DragAndDropDirective, _shared_directives_tippy_directive__WEBPACK_IMPORTED_MODULE_9__.TippyDirective],
      encapsulation: 2
    });
  }
}
