"use strict";
(self["webpackChunkeav_ui"] = self["webpackChunkeav_ui"] || []).push([["default-projects_eav-ui_src_app_shared_directives_mousedown-stop-propagation_directive_ts-pro-96cd25"],{
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs/operators */ 64334);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! rxjs/operators */ 98764);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! rxjs/operators */ 36647);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! rxjs/operators */ 63037);
...
class DragRef {
   ...
   */
  _hasStartedDragging = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.signal)(false);
  ...
  _moveEvents = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  ...
  _pointerMoveSubscription = rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription.EMPTY;
  /** Subscription to the event that is dispatched when the user lifts their pointer. */
  _pointerUpSubscription = rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription.EMPTY;
  /** Subscription to the viewport being scrolled. */
  _scrollSubscription = rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription.EMPTY;
  /** Subscription to the viewport being resized. */
  _resizeSubscription = rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription.EMPTY;
  /**
  ...
  beforeStarted = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when the user starts dragging the item. */
  started = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when the user has released a drag item, before any animations have started. */
  released = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when the user stops dragging an item in the container. */
  ended = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when the user has moved the item into a new container. */
  entered = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when the user removes the item its container by dragging it into another container. */
  exited = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when the user drops the item inside a container. */
  dropped = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /**
  ...
  withRootElement(rootElement) {
    ...
    if (element !== this._rootElement) {
      ...
      this._rootElementCleanups = this._ngZone.runOutsideAngular(() => [(0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, element, 'mousedown', this._pointerDown, activeEventListenerOptions), (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, element, 'touchstart', this._pointerDown, passiveEventListenerOptions), (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, element, 'dragstart', this._nativeDragStart, activeEventListenerOptions)]);
  ...
  _startDragSequence(event) {
    ...
    if (shadowRoot) {
      ...
      this._ngZone.runOutsideAngular(() => {
        this._cleanupShadowRootSelectStart = (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, shadowRoot, 'selectstart', shadowDomSelectStart, activeCapturingEventOptions$1);
      });
    }
    if (dropContainer) {
...
class DropListRef {
  ...
  sorted = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when a dragging sequence is started in a list connected to the current one. */
  receivingStarted = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /** Emits when a dragging sequence is stopped from a list connected to the current one. */
  receivingStopped = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  ...
  _viewportScrollSubscription = rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription.EMPTY;
  ...
  _stopScrollTimers = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
...
class DragDropRegistry {
  ...
  _document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_9__.DOCUMENT);
  _styleLoader = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_private__WEBPACK_IMPORTED_MODULE_10__._CdkPrivateStyleLoader);
  ...
  _activeDragInstances = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.signal)([]);
   ...
   */
  pointerMove = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /**
   * Emits the `touchend` or `mouseup` events that are dispatched
   * while the user is dragging a drag item instance.
   */
  pointerUp = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  /**
   * Emits when the viewport has been scrolled while the user is dragging an item.
   * @deprecated To be turned into a private member. Use the `scrolled` method instead.
   * @breaking-change 13.0.0
   */
  scroll = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  constructor() {}
  ...
  registerDragItem(drag) {
    ...
    if (this._dragInstances.size === 1) {
      this._ngZone.runOutsideAngular(() => {
        ...
        this._cleanupDocumentTouchmove = (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, this._document, 'touchmove', this._persistentTouchmoveListener, activeCapturingEventOptions);
      });
    }
  }
  ...
  startDragging(drag, event) {
    ...
    if (this._activeDragInstances().length === 1) {
      ...
      this._ngZone.runOutsideAngular(() => {
        this._globalListeners = toBind.map(([name, handler, options]) => (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, this._document, name, handler, options));
      });
    }
  }
  ...
  scrolled(shadowRoot) {
    ...
    if (shadowRoot && shadowRoot !== this._document) {
      ...
      streams.push(new rxjs__WEBPACK_IMPORTED_MODULE_11__.Observable(observer => {
        return this._ngZone.runOutsideAngular(() => {
          const cleanup = (0,_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_0__._bindEventWithOptions)(this._renderer, shadowRoot, 'scroll', event => {
...
class DragDrop {
  _document = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_9__.DOCUMENT);
  _ngZone = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.NgZone);
  _viewportRuler = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_13__.ViewportRuler);
  _dragDropRegistry = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(DragDropRegistry);
  _renderer = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.RendererFactory2).createRenderer(null, null);
  constructor() {}
  /**
...
class CdkDragHandle {
  element = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef);
  _parentDrag = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DRAG_PARENT, {
    optional: true,
    skipSelf: true
  });
  _dragDropRegistry = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(DragDropRegistry);
...
class CdkDrag {
  element = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef);
  dropContainer = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DROP_LIST, {
    optional: true,
    skipSelf: true
  });
  _ngZone = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.NgZone);
  ...
  _dir = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_14__.Directionality, {
    optional: true
  });
  ...
  _selfHandle = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DRAG_HANDLE, {
    optional: true,
    self: true
  });
  _parentDrag = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DRAG_PARENT, {
  ...
  _handles = new rxjs__WEBPACK_IMPORTED_MODULE_15__.BehaviorSubject([]);
  _previewTemplate;
  _placeholderTemplate;
   ...
   * because this event will fire for every pixel that the user has dragged.
   */
  moved = new rxjs__WEBPACK_IMPORTED_MODULE_11__.Observable(observer => {
    const subscription = this._dragRef.moved.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.map)(movedEvent => ({
      source: this,
  ...
  constructor() {
    ...
    const config = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DRAG_CONFIG, {
      optional: true
    });
    const dragDrop = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(DragDrop);
  ...
  _syncInputs(ref) {
    ...
    ref.beforeStarted.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.take)(1)).subscribe(() => {
  ...
  _setupHandlesListener() {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.switchMap)(handles => {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.merge)(...handles.map(item => item._stateChanges.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_20__.startWith)(item))));
...
class CdkDropList {
  element = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef);
  _changeDetectorRef = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ChangeDetectorRef);
  _scrollDispatcher = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_13__.ScrollDispatcher);
  _dir = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_14__.Directionality, {
    optional: true
  });
  _group = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DROP_LIST_GROUP, {
    optional: true,
    skipSelf: true
  });
   ...
   */
  id = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_5__._IdGenerator).getId('cdk-drop-list-');
  /** Locks the position of the draggable elements inside the container along the specified axis. */
  lockAxis;
  /** Whether starting a dragging sequence from this container is disabled. */
  get disabled() {
  ...
  _setupInputSyncSubscription(ref) {
    if (this._dir) {
      this._dir.change.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_20__.startWith)(this._dir.value), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.takeUntil)(this._destroyed)).subscribe(value => ref.withDirection(value));
    }
    ref.beforeStarted.subscribe(() => {
...
class CdkDragPreview {
  templateRef = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_core__WEBPACK_IMPORTED_MODULE_1__.TemplateRef);
  _drag = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(CDK_DRAG_PARENT, {
    optional: true
  });
...
class DragDropModule {
  ...
  static ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
    providers: [DragDrop],
    imports: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_13__.CdkScrollableModule]
  });
}
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DragDropModule, [{
    ...
    args: [{
      ...
      exports: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_13__.CdkScrollableModule, ...DRAG_DROP_DIRECTIVES],
      providers: [DragDrop]
    }]
  }], null, null);
})();
...
//# sourceMappingURL=default-projects_eav-ui_src_app_shared_directives_mousedown-stop-propagation_directive_ts-pro-96cd25.js.map